...
! function(t, e) {
    ...
    var h = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
        ...
        d = u("object" == typeof globalThis && globalThis) || u("object" == typeof window && window) || u("object" == typeof self && self) || u("object" == typeof h && h) || u("object" == typeof h && h) || function() {
            return this
    ...
    var k, T, C = function(t, e) {
        ...
        U = TypeError,
        z = function(t) {
            if (M(t)) throw new U("Can't call method on " + t);
            return t
        },
        q = L,
        W = z,
        ...
        Y = void 0 === K && void 0 !== K ? function(t) {
            return "function" == typeof t || t === K
        } : function(t) {
        ...
        Z = Y,
        tt = function(t, e) {
            return arguments.length < 2 ? (i = Q[t], Z(i) ? i : void 0) : Q[t] && Q[t][e];
            var i
        },
        et = E({}.isPrototypeOf),
        it = "undefined" != typeof navigator && String(navigator.userAgent) || "",
        nt = d,
        ot = it,
        rt = nt.process,
        at = nt.Deno,
        st = rt && rt.versions || at && at.version,
        lt = st && st.v8;
    lt && (T = (k = lt.split("."))[0] > 0 && k[0] < 4 ? 1 : +(k[0] + k[1])), !T && ot && (!(k = ot.match(/Edge\/(\d+)/)) || k[1] >= 74) && (k = ot.match(/Chrome\/(\d+)/)) && (T = +k[1]);
    var ct = T,
        ht = ct,
        ut = f,
        dt = d.String,
        pt = !!Object.getOwnPropertySymbols && !ut((function() {
            var t = Symbol("symbol detection");
            return !dt(t) || !(Object(t) instanceof Symbol) || !Symbol.sham && ht && ht < 41
        })),
        ft = pt && !Symbol.sham && "symbol" == typeof Symbol.iterator,
        gt = tt,
        vt = Y,
        bt = et,
        mt = Object,
        ...
        Tt = function(t) {
            if (xt(t)) return t;
            throw new kt(Ot(t) + " is not a function")
        },
        Ct = Tt,
        Pt = H,
        It = function(t, e) {
            var i = t[e];
            return Pt(i) ? void 0 : Ct(i)
        },
        At = y,
        $t = Y,
        Et = X,
    ...
    var Ht = jt.exports,
        ...
        ae = d.Symbol,
        se = ee("wks"),
        le = re ? ae.for || ae : ae && ae.withoutSetter || ne,
        ce = function(t) {
            return ie(se, t) || (se[t] = oe && ie(ae, t) ? ae[t] : le("Symbol." + t)), se[t]
        },
        he = y,
        ue = X,
        de = yt,
        ...
        fe = function(t, e) {
            var i, n;
            if ("string" === e && $t(i = t.toString) && !Et(n = At(i, t))) return n;
            if ($t(i = t.valueOf) && !Et(n = At(i, t))) return n;
            if ("string" !== e && $t(i = t.toString) && !Et(n = At(i, t))) return n;
        ...
        Se = X,
        xe = d.document,
        Oe = Se(xe) && Se(xe.createElement),
        ke = function(t) {
            return Oe ? xe.createElement(t) : {}
        },
        Te = ke,
        Ce = !g && !f((function() {
    ...
    p.f = Pe ? Ne : function(t, e) {
        if (t = Ee(t), e = Re(e), _e) try {
            return Ne(t, e)
        } catch (t) {}
        if (je(t, e)) return $e(!Ie(Ae.f, t, e), t[e])
    };
    var Fe = {},
        De = g && f((function() {
        ...
        He = function(t) {
            if (Ve(t)) return t;
            throw new Le(Be(t) + " is not an object")
        },
        Me = g,
        Ue = Ce,
        ze = De,
        ...
        Xe = "configurable",
        Qe = "writable";
    Fe.f = Me ? ze ? function(t, e, i) {
        if (qe(t), e = We(e), qe(i), "function" == typeof t && "prototype" === e && "value" in i && Qe in i && !i[Qe]) {
            var n = Ye(t, e);
            n && n[Qe] && (t[e] = i.value, i = {
                configurable: Xe in i ? i[Xe] : n[Xe],
                enumerable: Je in i ? i[Je] : n[Je],
                writable: !1
            })
        }
        return Ke(t, e, i)
    } : Ke : function(t, e, i) {
        if (qe(t), e = We(e), qe(i), Ue) try {
            return Ke(t, e, i)
        } catch (t) {}
        if ("get" in i || "set" in i) throw new Ge("Accessors not supported");
        return "value" in i && (t[e] = i.value), t
    };
    var Ze = Fe,
        ti = C,
        ei = g ? function(t, e, i) {
            return Ze.f(t, e, ti(1, i))
        } : function(t, e, i) {
            return t[e] = i, t
        },
        ii = {
        ...
        ai = ni && Object.getOwnPropertyDescriptor,
        si = oi(ri, "name"),
        li = {
            EXISTS: si,
            PROPER: si && "something" === function() {}.name,
            CONFIGURABLE: si && (!ni || ni && ai(ri, "name").configurable)
        },
        ci = Y,
        hi = Ht,
        ui = E(Function.toString);
    ci(hi.inspectSource) || (hi.inspectSource = function(t) {
        return ui(t)
    });
    var di, pi, fi, gi = hi.inspectSource,
        vi = Y,
        bi = d.WeakMap,
        ...
        ji = ki.WeakMap;
    if (Oi || Ii.state) {
        var _i = Ii.state || (Ii.state = new ji);
        _i.get = _i.get, _i.has = _i.has, _i.set = _i.set, di = function(t, e) {
            if (_i.has(t)) throw new Ri(Ei);
        ...
        var Ni = Ai("state");
        $i[Ni] = !0, di = function(t, e) {
            if (Pi(t, Ni)) throw new Ri(Ei);
            return e.facade = t, Ci(t, Ni, e), e
        }, pi = function(t) {
            return Pi(t, Ni) ? t[Ni] : {}
        }, fi = function(t) {
            return Pi(t, Ni)
    ...
    var Fi = {
            ...
            has: fi,
            enforce: function(t) {
                return fi(t) ? pi(t) : di(t, {})
            },
            getterFor: function(t) {
                return function(e) {
                    var i;
                    if (!Ti(e) || (i = pi(e)).type !== t) throw new Ri("Incompatible receiver, " + t + " required");
                    return i
                }
            }
        },
        ...
        Ji = Di([].join),
        Xi = Hi && !Vi((function() {
            return 8 !== Gi((function() {}), "length", {
                value: 8
            }).length
        })),
        Qi = String(String).split("String"),
        Zi = ii.exports = function(t, e, i) {
            "Symbol(" === Ki(Wi(e), 0, 7) && (e = "[" + Yi(Wi(e), /^Symbol\(([^)]*)\).*$/, "$1") + "]"), i && i.getter && (e = "get " + e), i && i.setter && (e = "set " + e), (!Li(t, "name") || Mi && t.name !== e) && (Hi ? Gi(t, "name", {
                value: e,
                configurable: !0
            }) : t.name = e), Xi && i && Li(i, "arity") && t.length !== i.arity && Gi(t, "length", {
                value: i.arity
            });
            try {
                i && Li(i, "constructor") && i.constructor ? Hi && Gi(t, "prototype", {
                    writable: !1
                }) : t.prototype && (t.prototype = void 0)
            } catch (t) {}
            var n = zi(t);
            return Li(n, "source") || (n.source = Ji(Qi, "string" == typeof e ? e : "")), t
        };
    Function.prototype.toString = Zi((function() {
        return Bi(this) && qi(this).source || Ui(this)
    }), "toString");
    var tn = ii.exports,
        en = Y,
        nn = Fe,
        ...
        an = function(t, e, i, n) {
            ...
            if (en(i) && on(i, r, n), n.global) o ? t[e] = i : rn(e, i);
            else {
                try {
        ...
        ln = Math.ceil,
        cn = Math.floor,
        hn = Math.trunc || function(t) {
            var e = +t;
            return (e > 0 ? cn : ln)(e)
        },
        un = function(t) {
            var e = +t;
            return e != e || 0 === e ? 0 : hn(e)
        },
        dn = un,
        pn = Math.max,
        fn = Math.min,
        gn = function(t, e) {
            var i = dn(t);
            return i < 0 ? pn(i + e, 0) : fn(i, e)
        },
        vn = un,
        bn = Math.min,
        mn = function(t) {
            var e = vn(t);
            return e > 0 ? bn(e, 9007199254740991) : 0
        },
        yn = mn,
        wn = function(t) {
            return yn(t.length)
        ...
        En = function(t, e) {
            var i, n = Pn(t),
                o = 0,
                r = [];
            for (i in n) !Cn(An, i) && Cn(n, i) && $n(r, i);
            for (; e.length > o;) Cn(n, i = e[o++]) && (~In(r, i) || $n(r, i));
            return r
        },
        Rn = ["constructor", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "toLocaleString", "toString", "valueOf"],
        jn = En,
        _n = Rn.concat("length", "prototype");
    ...
    var Fn = tt,
        ...
        Bn = He,
        Ln = E([].concat),
        Hn = Fn("Reflect", "ownKeys") || function(t) {
            var e = Dn.f(Bn(t)),
                i = Vn.f;
            return i ? Ln(e, i(t)) : e
        },
        ...
        Yn = function(t, e) {
            var i = Xn[Jn(t)];
            return i === Zn || i !== Qn && (Gn(e) ? Wn(e) : !!e)
        },
        Jn = Yn.normalize = function(t) {
        ...
        ro = Ft,
        ao = function(t, e, i) {
            for (var n = Un(e), o = qn.f, r = zn.f, a = 0; a < n.length; a++) {
                var s = n[a];
                Mn(t, s) || i && Mn(i, s) || o(t, s, r(e, s))
            }
        },
        so = to,
        lo = function(t, e) {
            var i, n, o, r, a, s = t.target,
                l = t.global,
                c = t.stat;
            if (i = l ? eo : c ? eo[s] || ro(s, {}) : eo[s] && eo[s].prototype)
                for (n in e) {
                    if (r = e[n], o = t.dontCallGetSet ? (a = io(i, n)) && a.value : i[n], !so(l ? n : s + (c ? "." : "#") + n, t.forced) && void 0 !== o) {
                        if (typeof r == typeof o) continue;
                        ao(r, o)
                    }(t.sham || o && o.sham) && no(r, "sham", !0), oo(i, n, r, t)
                }
        },
        co = N,
        ...
        vo = C,
        bo = function(t, e, i) {
            fo ? go.f(t, e, vo(0, i)) : t[e] = i
        },
        mo = {};
    mo[ce("toStringTag")] = "z";
    var yo = "[object z]" === String(mo),
        wo = yo,
        So = Y,
        xo = N,
        Oo = ce("toStringTag"),
        ko = Object,
        To = "Arguments" === xo(function() {
            return arguments
        }()),
        Co = wo ? xo : function(t) {
            var e, i, n;
            ...
            }(e = ko(t), Oo)) ? i : To ? xo(e) : "Object" === (n = xo(e)) && So(e.callee) ? "Arguments" : n
        },
        Po = E,
        Io = f,
        Ao = Y,
        ...
        Vo = function(t) {
            ...
            try {
                return Fo || !!No(_o, Eo(t))
            } catch (t) {
                return !0
            }
        };
    Vo.sham = !0;
    var Bo = !jo || Io((function() {
            var t;
        ...
        qo = function(t) {
            var e;
            return Lo(t) && (e = t.constructor, (Ho(e) && (e === zo || Lo(e.prototype)) || Mo(e) && null === (e = e[Uo])) && (e = void 0)), void 0 === e ? zo : e
        },
        Wo = function(t, e) {
        ...
        Yo = ce("species"),
        Jo = function(t) {
            return Ko >= 51 || !Go((function() {
                var e = [];
                return (e.constructor = {})[Yo] = function() {
                    return {
                        foo: 1
                    }
                }, 1 !== e[t](Boolean).foo
        ...
        ar = Jo,
        sr = ct,
        lr = ce("isConcatSpreadable"),
        cr = sr >= 51 || !Qo((function() {
            var t = [];
            return t[lr] = !1, t.concat()[0] !== t
        })),
        hr = function(t) {
            if (!tr(t)) return !1;
            var e = t[lr];
    ...
    Xo({
        ...
        concat: function(t) {
            var e, i, n, o, r, a = er(this),
                s = rr(a, 0),
                l = 0;
            for (e = -1, n = arguments.length; e < n; e++)
                if (hr(r = -1 === e ? a : arguments[e]))
                    for (o = ir(r), nr(l + o), i = 0; i < o; i++, l++) i in r && or(s, l, r[i]);
                else nr(l + 1), or(s, l++, r);
            return s.length = l, s
        }
    });
    var ur = N,
        dr = E,
        pr = function(t) {
            if ("Function" === ur(t)) return dr(t)
        },
        fr = Tt,
        gr = v,
        vr = pr(pr.bind),
        br = function(t, e) {
            return fr(t), void 0 === e ? t : gr ? vr(t, e) : function() {
        ...
        Or = function(t) {
            ...
            return function(l, c, h, u) {
                for (var d, p, f = yr(l), g = mr(f), v = wr(g), b = br(c, h), m = 0, y = u || Sr, w = e ? y(l, v) : i || a ? y(l, 0) : void 0; v > m; m++)
    ...
    var Cr = {},
        ...
        _r = G,
        Nr = Ar;
    Cr.f = $r && !Er ? Object.defineProperties : function(t, e) {
        jr(t);
        for (var i, n = _r(e), o = Nr(e), r = o.length, a = 0; r > a;) Rr.f(t, i = o[a++], n[i]);
        return t
    };
    var Fr, Dr = tt("document", "documentElement"),
        Vr = He,
        Br = Cr,
        Lr = Rn,
        Hr = xi,
        ...
        Jr = function() {
            ...
            var t, e, i;
            Jr = "undefined" != typeof document ? document.domain && Fr ? Yr(Fr) : (e = Ur("iframe"), i = "java" + qr + ":", e.style.display = "none", Mr.appendChild(e), e.src = String(i), (t = e.contentWindow.document).open(), t.write(Kr("document.F=Object")), t.close(), t.F) : Yr(Fr);
            for (var n = Lr.length; n--;) delete Jr[zr][Lr[n]];
            return Jr()
        };
    Hr[Wr] = !0;
    var Xr = Object.create || function(t, e) {
            var i;
            return null !== t ? (Gr[zr] = Vr(t), i = new Gr, Gr[zr] = null, i[Wr] = t) : i = Jr(), void 0 === e ? i : Br.f(i, e)
        },
        Qr = ce,
        Zr = Xr,
        ta = Fe.f,
    ...
    var Oa, ka, Ta, Ca = {},
        ...
        ja = Object,
        _a = ja.prototype,
        Na = Ea ? ja.getPrototypeOf : function(t) {
            var e = $a(t);
            if (Ia(e, Ra)) return e[Ra];
            var i = e.constructor;
        ...
        Ha = ce("iterator"),
        Ma = !1;
    [].keys && ("next" in (Ta = [].keys()) ? (ka = Ba(Ba(Ta))) !== Object.prototype && (Oa = ka) : Ma = !0);
    var Ua = !Va(Oa) || Fa((function() {
        var t = {};
        return Oa[Ha].call(t) !== t
    }));
    Ua && (Oa = {}), Da(Oa[Ha]) || La(Oa, Ha, (function() {
        return this
    }));
    var za = {
        ...
        Ga = ce("toStringTag"),
        Ka = function(t, e, i) {
            t && !i && (t = t.prototype), t && !Wa(t, Ga) && qa(t, Ga, {
                configurable: !0,
                value: e
            })
        },
        ...
        Fs = function(t, e, i, n, o, r, a) {
            ...
            if (v && (s = vs(v.call(new t))) !== Object.prototype && s.next && (vs(s) !== ks && (bs ? bs(s, ks) : fs(s[Cs]) || ws(s, Cs, $s)), ms(s, u, !0)), xs && o === Is && f && f.name !== Is && (Os ? ys(p, "name", Is) : (d = !0, g = function() {
                    return ps(f, this)
                })), o)
                if (l = {
                        values: h(Is),
                    ...
                    for (c in l)(Ts || d || !(c in p)) && ws(p, c, l[c]);
                else ds({
                    target: e,
                    proto: !0,
                    forced: Ts || d
                }, l);
            return p[Cs] !== g && ws(p, Cs, g, {
                name: o
            }), Ss[e] = g, l
        },
        Ds = function(t, e) {
        ...
        Ls = _s.set,
        Hs = _s.getterFor(Bs),
        Ms = Fs(Array, "Array", (function(t, e) {
            Ls(this, {
                type: Bs,
                target: Es(t),
                index: 0,
    ...
    if (Rs("keys"), Rs("values"), Rs("entries"), Vs && "values" !== Us.name) try {
        Ns(Us, "name", {
            value: "values"
        })
    } catch (t) {}
    ...
    Js({
        target: "Array",
        proto: !0,
        forced: String(Zs) === String(Zs.reverse())
    }, {
        reverse: function() {
    ...
    el({
        ...
        slice: function(t, e) {
            var i, n, o, r = sl(this),
                ...
                s = rl(t, a),
                l = rl(void 0 === e ? a : e, a);
            if (il(r) && (i = r.constructor, (nl(i) && (i === pl || il(i.prototype)) || ol(i) && null === (i = i[dl])) && (i = void 0), i === pl || void 0 === i)) return hl(r, s, l);
            for (n = new(void 0 === i ? pl : i)(fl(l - s, 0)), o = 0; s < l; s++, o++) s in r && ll(n, o, r[s]);
            return n.length = o, n
        }
    });
    var gl = St,
        ...
        Ol = function(t, e) {
            ...
            if (i < 8)
                for (var n, o, r = 1; r < i;) {
                    ...
                    for (var a = xl(i / 2), s = Ol(Sl(t, 0, a), e), l = Ol(Sl(t, a), e), c = s.length, h = l.length, u = 0, d = 0; u < c || d < h;) t[u + d] = u < c && d < h ? e(s[u], l[d]) <= 0 ? s[u++] : l[d++] : u < c ? s[u++] : l[d++];
            return t
        },
        kl = Ol,
        Tl = it.match(/firefox\/(\d+)/i),
        Cl = !!Tl && +Tl[1],
        Pl = /MSIE|Trident/.test(it),
        Il = it.match(/AppleWebKit\/(\d+)\./),
        Al = !!Il && +Il[1],
        $l = lo,
        El = E,
        Rl = Tt,
        ...
        Jl = !Dl((function() {
            ...
            if (!(Ll && Ll > 3)) {
                ...
                for (t = 65; t < 76; t++) {
                    ...
                    for (n = 0; n < 47; n++) zl.push({
                        k: e + n,
                        v: i
                    })
                }
                for (zl.sort((function(t, e) {
                        return e.v - t.v
                    })), n = 0; n < zl.length; n++) e = zl[n].k.charAt(0), o.charAt(o.length - 1) !== e && (o += e);
    ...
    ic({
        ...
        splice: function(t, e) {
            var i, n, o, r, a, s, l = nc(this),
                c = ac(l),
                h = oc(t, c),
                u = arguments.length;
            for (0 === u ? i = n = 0 : 1 === u ? (i = 0, n = c - h) : (i = u - 2, n = fc(pc(rc(e), 0), c - h)), lc(c + i - n), o = cc(l, n), r = 0; r < n; r++)(a = h + r) in l && hc(o, r, l[a]);
            if (o.length = n, i < n) {
                for (r = h; r < c - n; r++) s = r + i, (a = r + n) in l ? l[s] = l[a] : uc(l, s);
                for (r = c; r > c - n + i; r--) uc(l, r - 1)
            } else if (i > n)
                for (r = c - n; r > h; r--) s = r + i - 1, (a = r + n - 1) in l ? l[s] = l[a] : uc(l, s);
    ...
    var bc = d,
        ...
        Sc = function(t, e, i) {
            var n, o;
            return wc && mc(n = e.constructor) && n !== i && yc(o = n.prototype) && o !== i.prototype && wc(t, o), t
        },
        xc = E(1..valueOf),
        Oc = "\t\n\v\f\r                　\u2028\u2029\ufeff",
        kc = z,
        ...
        $c = function(t) {
            return function(e) {
                var i = Tc(kc(e));
                return 1 & t && (i = Pc(i, Ic, "")), 2 & t && (i = Pc(i, Ac, "$1")), i
            }
        },
        Ec = {
            start: $c(1),
    ...
    var Xc = Jc.prototype,
        ...
        th = Fc("".charCodeAt),
        eh = function(t) {
            var e, i, n, o, r, a, s, l, c = Mc(t, "number");
        ...
        ih = Dc(Yc, !Jc(" 0o1") || !Jc("0b1") || Jc("+0x1")),
        nh = function(t) {
            var e, i = arguments.length < 1 ? 0 : Jc(function(t) {
                var e = Mc(t, "number");
                return "bigint" == typeof e ? e : eh(e)
            }(t));
            return Lc(Xc, e = this) && Uc((function() {
                Gc(e)
            })) ? Bc(Object(i), this, nh) : i
        };
    nh.prototype = Xc, ih && (Xc.constructor = nh), Rc({
        global: !0,
        constructor: !0,
        wrap: !0,
        forced: ih
    ...
    ih && function(t, e) {
        for (var i, n = jc ? zc(e) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,isFinite,isInteger,isNaN,isSafeInteger,parseFloat,parseInt,fromString,range".split(","), o = 0; n.length > o; o++) Vc(e, i = n[o]) && !Vc(t, i) && Wc(t, i, qc(e, i))
    }(Nc[Yc], Jc);
    var oh = g,
        rh = E,
        ah = y,
        ...
        vh = !ph || sh((function() {
            ...
            return t[i] = 7, n.split("").forEach((function(t) {
                e[t] = t
            })), 7 !== ph({}, t)[i] || lh(ph({}, e)).join("") !== n
        })) ? function(t, e) {
            for (var i = uh(t), n = arguments.length, o = 1, r = ch.f, a = hh.f; n > o;)
                for (var s, l = dh(arguments[o++]), c = r ? gh(lh(l), r(l)) : lh(l), h = c.length, u = 0; h > u;) s = c[u++], oh && !ah(a, l, s) || (i[s] = l[s]);
            return i
        } : ph,
        bh = vh;
    lo({
    ...
    var mh = g,
        ...
        Ph = function(t) {
            return function(e) {
                for (var i, n = Oh(e), o = xh(n), r = Ch && null === Sh(n), a = o.length, s = 0, l = []; a > s;) i = o[s++], mh && !(r ? i in n : kh(n, i)) || Th(l, t ? [i, n[i]] : n[i]);
                return l
            }
        },
        Ih = {
    ...
    var Eh = Co,
        Rh = yo ? {}.toString : function() {
            return "[object " + Eh(this) + "]"
        };
    yo || an(Object.prototype, "toString", Rh, {
        unsafe: !0
    });
    var jh = d,
        _h = f,
        ...
        Lh = jh.Symbol,
        Hh = Lh && Lh.iterator,
        Mh = 1 / Bh(Dh + "-0") != -1 / 0 || Hh && !_h((function() {
            Bh(Object(Hh))
        })) ? function(t) {
            var e = Fh(Nh(t)),
                i = Bh(e);
            return 0 === i && "-" === Vh(e, 0) ? -0 : i
        } : Bh;
    lo({
        global: !0,
        forced: parseFloat !== Mh
    }, {
        parseFloat: Mh
    });
    var Uh = d,
        ...
        Qh = /^[+-]?0x/i,
        Zh = qh(Qh.exec),
        tu = 8 !== Yh(Kh + "08") || 22 !== Yh(Kh + "0x16") || Xh && !zh((function() {
            Yh(Object(Xh))
        })) ? function(t, e) {
            var i = Gh(Wh(t));
            return Yh(i, e >>> 0 || (Zh(Qh, i) ? 16 : 10))
        } : Yh;
    lo({
        global: !0,
        forced: parseInt !== tu
    ...
    var eu = X,
        ...
        ou = function(t) {
            var e;
            return eu(t) && (void 0 !== (e = t[nu]) ? !!e : "RegExp" === iu(t))
        },
        ru = He,
        au = function() {
            var t = ru(this),
        ...
        du = function(t) {
            var e = t.flags;
            return void 0 !== e || "flags" in uu || lu(t, "flags") || !cu(uu, t) ? e : su(hu, t)
        },
        pu = f,
        fu = d.RegExp,
        gu = pu((function() {
        ...
        ud = Uu.MISSED_STICKY,
        dd = Uu.UNSUPPORTED_Y,
        pd = Eu && (!hd || ud || Ju || Xu || Wu((function() {
            return cd[Qu] = !1, Zu(ld) !== ld || Zu(cd) === cd || "/a/i" !== String(Zu(ld, "i"))
        })));
    if (_u("RegExp", pd)) {
        for (var fd = function(t, e) {
                var i, n, o, r, a, s, l = Bu(td, this),
                    c = Lu(t),
                    h = void 0 === e,
                    u = [],
                    d = t;
                if (!l && c && h && t.constructor === fd) return t;
                if ((c || Bu(td, t)) && (t = t.source, h && (e = Mu(d))), t = void 0 === t ? "" : Hu(t), e = void 0 === e ? "" : Hu(e), d = t, Ju && "dotAll" in ld && (n = !!e && rd(e, "s") > -1) && (e = od(e, /s/g, "")), i = e, ud && "sticky" in ld && (o = !!e && rd(e, "y") > -1) && dd && (e = od(e, /y/g, "")), Xu && (r = function(t) {
                        for (var e, i = t.length, n = 0, o = "", r = [], a = Du(null), s = !1, l = !1, c = 0, h = ""; n <= i; n++) {
                            if ("\\" === (e = nd(t, n))) e += nd(t, ++n);
                            else if ("]" === e) s = !1;
                            else if (!s) switch (!0) {
                                case "[" === e:
                                    s = !0;
                                    break;
                                case "(" === e:
                                    id(sd, ad(t, n + 1)) && (n += 2, l = !0), o += e, c++;
                                    continue;
                                case ">" === e && l:
                                    if ("" === h || Gu(a, h)) throw new ed("Invalid capture group name");
                        ...
                        return [o, r]
                    }(t), t = r[0], u = r[1]), a = Nu(Zu(t, e), l ? this : td, fd), (n || o || u.length) && (s = Ku(a), n && (s.dotAll = !0, s.raw = fd(function(t) {
                        for (var e, i = t.length, n = 0, o = "", r = !1; n <= i; n++) "\\" !== (e = nd(t, n)) ? r || "." !== e ? ("[" === e ? r = !0 : "]" === e && (r = !1), o += e) : o += "[\\s\\S]" : o += e + nd(t, ++n);
                        return o
                    }(t), i)), o && (s.sticky = !0), u.length && (s.groups = u)), t !== d) try {
                    Fu(a, "source", "" === d ? "(?:)" : d)
                } catch (t) {}
                return a
            }, gd = Vu(Zu), vd = 0; gd.length > vd;) zu(fd, Zu, gd[vd++]);
        td.constructor = fd, fd.prototype = td, qu(Ru, "RegExp", fd, {
            constructor: !0
        })
    }
    Yu("RegExp");
    var bd = y,
        ...
        kd = Pu,
        Td = $u,
        Cd = Ut("native-string-replace", String.prototype.replace),
        Pd = RegExp.prototype.exec,
        Id = Pd,
        Ad = md("".charAt),
        $d = md("".indexOf),
        Ed = md("".replace),
        ...
        jd = function() {
            var t = /a/,
                e = /b*/g;
            return bd(Pd, t, "a"), bd(Pd, e, "a"), 0 !== t.lastIndex || 0 !== e.lastIndex
        }(),
        _d = Sd.BROKEN_CARET,
        Nd = void 0 !== /()??/.exec("")[1];
    (jd || Nd || _d || kd || Td) && (Id = function(t) {
        var e, i, n, o, r, a, s, l = this,
            c = Od(l),
            h = yd(t),
            u = c.raw;
        if (u) return u.lastIndex = l.lastIndex, e = bd(Id, u, h), l.lastIndex = u.lastIndex, e;
        var d = c.groups,
            p = _d && l.sticky,
            f = bd(wd, l),
            g = l.source,
            v = 0,
            b = h;
        if (p && (f = Ed(f, "y", ""), -1 === $d(f, "g") && (f += "g"), b = Rd(h, l.lastIndex), l.lastIndex > 0 && (!l.multiline || l.multiline && "\n" !== Ad(h, l.lastIndex - 1)) && (g = "(?: " + g + ")", b = " " + b, v++), i = new RegExp("^(?:" + g + ")", f)), Nd && (i = new RegExp("^" + g + "$(?!\\s)", f)), jd && (n = l.lastIndex), o = bd(Pd, p ? i : l, b), p ? o ? (o.input = Rd(o.input, v), o[0] = Rd(o[0], v), o.index = l.lastIndex, l.lastIndex += o[0].length) : l.lastIndex = 0 : jd && o && (l.lastIndex = l.global ? o.index + o[0].length : n), Nd && o && o.length > 1 && bd(Cd, o[0], i, (function() {
                for (r = 1; r < arguments.length - 2; r++) void 0 === arguments[r] && (o[r] = void 0)
            })), o && d)
            for (o.groups = a = xd(null), r = 0; r < d.length; r++) a[(s = d[r])[0]] = o[s[1]];
        return o
    });
    var Fd = Id;
    lo({
    ...
    var Kd = ou,
        Yd = TypeError,
        Jd = function(t) {
            if (Kd(t)) throw new Yd("The method doesn't accept regular expressions");
            return t
        },
        Xd = ce("match"),
        Qd = function(t) {
    ...
    Zd({
        ...
        includes: function(t) {
            return !!~op(ip(ep(this)), ip(tp(t)), arguments.length > 1 ? arguments[1] : void 0)
        }
    });
    var rp = v,
        ...
        sp = ap.apply,
        lp = ap.call,
        cp = "object" == typeof Reflect && Reflect.apply || (rp ? lp.bind(sp) : function() {
            return lp.apply(sp, arguments)
        }),
        hp = y,
        up = an,
        dp = Fd,
        ...
        mp = function(t, e, i, n) {
            var o = fp(t),
                ...
                a = r && !pp((function() {
                    var e = !1,
                        i = /a/;
                    return "split" === t && ((i = {}).constructor = {}, i.constructor[vp] = function() {
                        return i
            ...
            if (!r || !a || i) {
                ...
                up(String.prototype, t, l[0]), up(bp, o, l[1])
            }
            n && gp(bp[o], "sham", !0)
        },
        yp = E,
        ...
        Cp = function(t) {
            return function(e, i) {
                var n, o, r = Sp(xp(e)),
                    a = wp(i),
                    s = r.length;
                return a < 0 || a >= s ? t ? "" : void 0 : (n = kp(r, a)) < 55296 || n > 56319 || a + 1 === s || (o = kp(r, a + 1)) < 56320 || o > 57343 ? t ? Op(r, a) : n : t ? Tp(r, a, a + 2) : o - 56320 + (n - 55296 << 10) + 65536
            }
        },
        Pp = {
            codeAt: Cp(!1),
        ...
        Up = function(t, e) {
            ...
            if (Bp(i)) {
                var n = Dp(i, t, e);
                return null !== n && Vp(n), n
            }
            if ("RegExp" === Lp(t)) return Dp(Hp, t, e);
            throw new Mp("RegExp#exec called on incompatible receiver")
        },
        zp = cp,
        qp = y,
        Wp = E,
        ...
        nf = Ip,
        of = It,
        rf = function(t, e, i, n, o, r) {
            var a = i + t.length,
                s = n.length,
                l = Fp;
            return void 0 !== o && (o = $p(o), l = Np), jp(r, l, (function(r, l) {
                var c;
                switch (Rp(l, 0)) {
                    case "$":
                        return "$";
                    ...
                    default:
                        ...
                        if (h > s) {
                            var u = Ep(h / 10);
                            return 0 === u ? r : u <= s ? void 0 === n[u - 1] ? Rp(l, 1) : n[u - 1] + Rp(l, 1) : r
                        }
                        c = n[h - 1]
                }
                return void 0 === c ? "" : c
        ...
        ff = "$0" === "a".replace(/./, "$0"),
        gf = !!/./ [sf] && "" === /./ [sf]("a", "$0");
    Gp("replace", (function(t, e, i) {
        var n = gf ? "$" : "$0";
        return [function(t, i) {
            var n = ef(this),
                o = Xp(t) ? void 0 : of(t, sf);
            return o ? qp(o, t, n, i) : qp(e, tf(n), t, i)
        }, function(t, o) {
            var r = Yp(this),
                a = tf(t);
            if ("string" == typeof o && -1 === df(o, n) && -1 === df(o, "$<")) {
                var s = i(e, r, a, o);
            ...
            for (var u, d = []; null !== (u = af(r, a)) && (uf(d, u), h);) {
                "" === tf(u[0]) && (r.lastIndex = nf(a, Zp(r.lastIndex), c))
            }
            for (var p, f = "", g = 0, v = 0; v < d.length; v++) {
                for (var b, m = tf((u = d[v])[0]), y = lf(cf(Qp(u.index), a.length), 0), w = [], S = 1; S < u.length; S++) uf(w, void 0 === (p = u[S]) ? p : String(p));
                var x = u.groups;
                if (l) {
                    var O = hf([m], w, y, a);
                    void 0 !== x && uf(O, x), b = tf(zp(o, void 0, O))
                } else b = rf(m, a, y, w, x, o);
                y >= g && (f += pf(a, g, y) + b, g = y + m.length)
            }
            return f + pf(a, g)
        }]
    }), !!Kp((function() {
    ...
    var vf = Object.is || function(t, e) {
        ...
        Of = It,
        kf = Up;
    mp("search", (function(t, e, i) {
        return [function(e) {
            var i = wf(this),
                n = yf(e) ? void 0 : Of(e, t);
            return n ? bf(n, e, i) : new RegExp(e)[t](xf(i))
        }, function(t) {
            var n = mf(this),
                o = xf(t),
                r = i(e, n, o);
            ...
            var a = n.lastIndex;
            Sf(a, 0) || (n.lastIndex = 0);
            var s = kf(n, o);
            return Sf(n.lastIndex, a) || (n.lastIndex = a), null === s ? -1 : s.index
        }]
    }));
    var Tf = Bo,
        Cf = St,
        ...
        Af = function(t) {
            if (Tf(t)) return t;
            throw new Pf(Cf(t) + " is not a constructor")
        },
        $f = H,
        Ef = ce("species"),
        Rf = y,
        ...
        Df = z,
        Vf = function(t, e) {
            var i, n = If(t).constructor;
            return void 0 === n || $f(i = If(n)[Ef]) ? e : Af(i)
        },
        Bf = Ip,
        Lf = mn,
        Hf = wl,
        ...
        Jf = "c" === "abbc".split(/(b)*/)[1] || 4 !== "test".split(/(?:)/, -1).length || 2 !== "ab".split(/(?:ab)*/).length || 4 !== ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length;
    _f("split", (function(t, e, i) {
        var n = "0".split(void 0, 0).length ? function(t, i) {
            return void 0 === t && 0 === i ? [] : Rf(e, this, t, i)
        } : e;
        return [function(e, i) {
            var o = Df(this),
                r = Ff(e) ? void 0 : Mf(e, t);
            return r ? Rf(r, e, o, i) : Rf(n, Hf(o), e, i)
        }, function(t, o) {
            var r = Nf(this),
                a = Hf(t);
            if (!Jf) {
            ...
            var l = Vf(r, RegExp),
                c = r.unicode,
                h = (r.ignoreCase ? "i" : "") + (r.multiline ? "m" : "") + (r.unicode ? "u" : "") + (qf ? "g" : "y"),
                u = new l(qf ? "^(?:" + r.source + ")" : r, h),
                d = void 0 === o ? 4294967295 : o >>> 0;
            if (0 === d) return [];
            if (0 === a.length) return null === Uf(u, a) ? [a] : [];
            for (var p = 0, f = 0, g = []; f < a.length;) {
                u.lastIndex = qf ? 0 : f;
                var v, b = Uf(u, qf ? Kf(a, f) : a);
                if (null === b || (v = Wf(Lf(u.lastIndex + (qf ? f : 0)), a.length)) === p) f = Bf(a, f, c);
                else {
                    if (Gf(g, Kf(a, p, f)), g.length === d) return g;
                    for (var m = 1; m <= b.length - 1; m++)
                        if (Gf(g, b[m]), g.length === d) return g;
                    f = p = v
                }
            }
            return Gf(g, Kf(a, p)), g
        }]
    }), Jf || !Yf, qf);
    var Xf = li.PROPER,
        Qf = f,
    ...
    var eg = {
        ...
        ig = ke("span").classList,
        ng = ig && ig.constructor && ig.constructor.prototype,
        og = ng === Object.prototype ? void 0 : ng,
        rg = kr.forEach,
        ag = ba("forEach") ? [].forEach : function(t) {
        ...
        ug = ei,
        dg = function(t) {
            if (t && t.forEach !== hg) try {
                ug(t, "forEach", hg)
            } catch (e) {
                t.forEach = hg
            }
        };
    for (var pg in lg) lg[pg] && dg(sg[pg] && sg[pg].prototype);
    dg(cg);
    var fg = d,
        gg = eg,
        vg = og,
    ...
    for (var Og in gg) xg(fg[Og] && fg[Og].prototype, Og);
    xg(vg, "DOMTokenList");
    var kg = Wt,
        Tg = Na,
        Cg = Pa;
    ...
    Ig({
        target: "String",
        proto: !0,
        forced: !!(Vg || (Pg = $g(String.prototype, "endsWith"), !Pg || Pg.writable)) && !Vg
    }, {
        endsWith: function(t) {
            var e = Rg(_g(this));
            jg(t);
            var i = arguments.length > 1 ? arguments[1] : void 0,
                n = e.length,
                o = void 0 === i ? n : Dg(Eg(i), n),
                r = Rg(t);
            return Fg(e, o - r.length, o) === r
        }
    });
    var Bg = y,
        Lg = He,
    ...
    var Kg = lo,
        ...
        ov = ev("startsWith"),
        rv = !ov && !! function() {
            var t = Jg(String.prototype, "startsWith");
            return t && !t.writable
        }();
    Kg({
        target: "String",
        ...
        startsWith: function(t) {
            var e = Qg(tv(this));
            Zg(t);
            var i = Xg(nv(arguments.length > 1 ? arguments[1] : void 0, e.length)),
                n = Qg(t);
            return iv(e, i, i + n.length) === n
        }
    });
    var av = {
            ...
            extend: function() {
                ...
                var o, r = i[0] || {},
                    a = 1,
                    s = !1;
                for ("boolean" == typeof r && (s = r, r = i[a] || {}, a++), "object" !== l(r) && "function" != typeof r && (r = {}); a < i.length; a++) {
                    var c = i[a];
                    if (null != c)
                        for (var h in c) {
                            var u = c[h];
                            if ("__proto__" !== h && r !== u) {
                                ...
                                if (s && u && (this.isObject(u) || d)) {
                                    ...
                                    o = d && !Array.isArray(p) ? [] : d || this.isObject(p) ? p : {}, r[h] = this.extend(s, o, u)
                                } else void 0 !== u && (r[h] = u)
                            }
                        }
                }
            ...
            updateFieldGroup: function(t, e) {
                var i, n, r = (i = []).concat.apply(i, a(t)),
                    s = o(t);
                try {
                    for (s.s(); !(n = s.n()).done;) {
                        var l, c = o(n.value);
            ...
            calculateObjectValue: function(t, e, i, n) {
                ...
                return null !== r && "object" === l(r) ? r : "function" == typeof r ? r.apply(t, i || []) : !r && "string" == typeof e && i && this.sprintf.apply(this, [e].concat(a(i))) ? this.sprintf.apply(this, [e].concat(a(i))) : n
            },
            ...
            checkAutoMergeCells: function(t) {
                ...
                try {
                    for (i.s(); !(e = i.n()).done;)
                        for (var n = e.value, r = 0, a = Object.keys(n); r < a.length; r++) {
                            var s = a[r];
            ...
            replaceSearchMark: function(t, e) {
                ...
                return i.innerHTML = t,
                    function t(e, i) {
                        var n, r = new RegExp(i, "gim"),
                            a = o(e.childNodes);
                        try {
                            for (a.s(); !(n = a.n()).done;) {
                                var s = n.value;
                                s.nodeType === document.TEXT_NODE && (s.data = s.data.replace(r, (function(t) {
                                    return "___".concat(t, "___")
                                }))), s.nodeType === document.ELEMENT_NODE && t(s, i)
                            }
                        } catch (t) {
                            a.e(t)
                        } finally {
                    ...
                    }(i, e), i.innerHTML.replace(new RegExp("___".concat(e, "___"), "gim"), (function(t) {
                        return "<mark>".concat(t.slice(3, -3), "</mark>")
                    }))
            }
        },
        sv = av.getBootstrapVersion(),
        lv = {
            3: {
                classes: {
                    buttonsPrefix: "btn",
        ...
        cv = {
            ...
            buttonsPrefix: lv.classes.buttonsPrefix,
            buttonsClass: lv.classes.buttons,
            iconsPrefix: void 0,
            icons: {},
            iconSize: void 0,
            fixedScroll: !1,
    ...
    var dv = {
        ...
        fv = function() {
            function e(n, o) {
                i(this, e), this.options = o, this.$el = t(n), this.$el_ = this.$el.clone(), this.timeoutId_ = 0, this.timeoutFooter_ = 0
            }
            return n(e, [{
                key: "init",
                value: function() {
                ...
                value: function() {
                    var e = this.options;
                    this.constants = dv.CONSTANTS, this.constants.theme = t.fn.bootstrapTable.theme, this.constants.dataToggle = this.constants.html.dataToggle || "data-toggle";
                    var i = av.getIconsPrefix(t.fn.bootstrapTable.theme);
                    "string" == typeof e.icons && (e.icons = av.calculateObjectValue(null, e.icons)), e.iconsPrefix = e.iconsPrefix || t.fn.bootstrapTable.defaults.iconsPrefix || i, e.icons = Object.assign(av.getIcons(e.iconsPrefix), t.fn.bootstrapTable.defaults.icons, e.icons);
                    var n = e.buttonsPrefix ? "".concat(e.buttonsPrefix, "-") : "";
                    this.constants.buttonsClass = [e.buttonsPrefix, n + e.buttonsClass, av.sprintf("".concat(n, "%s"), e.iconSize)].join(" ").trim(), this.buttons = av.calculateObjectValue(this, e.buttons, [], {}), "object" !== l(this.buttons) && (this.buttons = {})
                }
            }, {
                key: "initLocale",
                value: function() {
                    if (this.options.locale) {
                        ...
                        var o = {};
                        i[this.options.locale] ? o = i[this.options.locale] : i[n.join("-")] ? o = i[n.join("-")] : i[n[0]] && (o = i[n[0]]), this._defaultLocales = this._defaultLocales || {};
                        for (var a = 0, s = Object.entries(o); a < s.length; a++) {
                            var l = r(s[a], 2),
                                c = l[0],
                                h = l[1],
                                u = this._defaultLocales.hasOwnProperty(c) ? this._defaultLocales[c] : e.DEFAULTS[c];
                ...
                value: function() {
                    var e = ["top", "both"].includes(this.options.paginationVAlign) ? '<div class="fixed-table-pagination clearfix"></div>' : "",
                        ...
                        n = av.calculateObjectValue(this.options, this.options.loadingTemplate, [this.options.formatLoadingMessage()]);
                ...
                value: function() {
                    ...
                    if (this.$header = this.$el.find(">thead"), this.$header.length ? this.options.theadClasses && this.$header.addClass(this.options.theadClasses) : this.$header = t('<thead class="'.concat(this.options.theadClasses, '"></thead>')).appendTo(this.$el), this._headerTrClasses = [], this._headerTrStyles = [], this.$header.find("tr").each((function(e, o) {
                        ...
                        })), Array.isArray(this.options.columns[0]) || (this.options.columns = [this.options.columns]), this.options.columns = av.extend(!0, [], n, this.options.columns), this.columns = [], this.fieldsColumnsIndex = [], av.setFieldIndex(this.options.columns), this.options.columns.forEach((function(t, n) {
                            t.forEach((function(t, o) {
                                var r = av.extend({}, e.COLUMN_DEFAULTS, t, {
                                    passed: t
                                });
                                void 0 !== r.fieldIndex && (i.columns[r.fieldIndex] = r, i.fieldsColumnsIndex[r.field] = r.fieldIndex), i.options.columns[n][o] = r
                            }))
                        })), !this.options.data.length) {
                        var o = av.trToData(this.columns, this.$el.find(">tbody>tr"));
                        o.length && (this.options.data = o, this.fromHtml = !0)
                    }
                    this.options.pagination && "server" !== this.options.sidePagination || (this.footerData = av.trToData(this.columns, this.$el.find(">tfoot>tr"))), this.footerData && this.$el.find("tfoot").html("<tr></tr>"), !this.options.showFooter || this.options.cardView ? this.$tableFooter.hide() : this.$tableFooter.show()
                }
            }, {
                key: "initHeader",
                value: function() {
                    ...
                    this.header = {
                        ...
                        cellStyles: [],
                        searchables: []
                    }, av.updateFieldGroup(this.options.columns, this.columns), this.options.columns.forEach((function(t, o) {
                        var a = [];
                        a.push("<tr".concat(av.sprintf(' class="%s"', e._headerTrClasses[o]), " ").concat(av.sprintf(' style="%s"', e._headerTrStyles[o]), ">"));
                        var s = "";
                        if (0 === o && av.hasDetailViewIcon(e.options)) {
                            var c = e.options.columns.length > 1 ? ' rowspan="'.concat(e.options.columns.length, '"') : "";
                            s = '<th class="detail"'.concat(c, '>\n          <div class="fht-cell"></div>\n          </th>')
                        }
                        s && "right" !== e.options.detailViewAlign && a.push(s), t.forEach((function(t, n) {
                            var s = av.sprintf(' class="%s"', t.class),
                                c = t.widthUnit,
                                h = parseFloat(t.width),
                                u = t.halign ? t.halign : t.align,
                                d = av.sprintf("text-align: %s; ", u),
                                p = av.sprintf("text-align: %s; ", t.align),
                                f = av.sprintf("vertical-align: %s; ", t.valign);
                            if (f += av.sprintf("width: %s; ", !t.checkbox && !t.radio || h ? h ? h + c : void 0 : t.showSelectTitle ? void 0 : "36px"), void 0 !== t.fieldIndex || t.visible) {
                                var g = av.calculateObjectValue(null, e.options.headerStyle, [t]),
                                    v = [],
                                    b = [],
                                    m = "";
                                if (g && g.css)
                                ...
                                if (g && g.classes && (m = av.sprintf(' class="%s"', t.class ? [t.class, g.classes].join(" ") : g.classes)), void 0 !== t.fieldIndex) {
                                    if (e.header.fields[t.fieldIndex] = t.field, e.header.styles[t.fieldIndex] = p + f, e.header.classes[t.fieldIndex] = s, e.header.formatters[t.fieldIndex] = t.formatter, e.header.detailFormatters[t.fieldIndex] = t.detailFormatter, e.header.events[t.fieldIndex] = t.events, e.header.sorters[t.fieldIndex] = t.sorter, e.header.sortNames[t.fieldIndex] = t.sortName, e.header.cellStyles[t.fieldIndex] = t.cellStyle, e.header.searchables[t.fieldIndex] = t.searchable, !t.visible) return;
                                ...
                                if (Object.keys(t._data || {}).length > 0)
                                    for (var k = 0, T = Object.entries(t._data); k < T.length; k++) {
                                        var C = r(T[k], 2),
                                            P = C[0],
                                            I = C[1];
                                        b.push("data-".concat(P, "='").concat("object" === l(I) ? JSON.stringify(I) : I, "'"))
                                    }
                                a.push("<th".concat(av.sprintf(' title="%s"', t.titleTooltip)), t.checkbox || t.radio ? av.sprintf(' class="bs-checkbox %s"', t.class || "") : m || s, av.sprintf(' style="%s"', d + f + v.join("; ") || void 0), av.sprintf(' rowspan="%s"', t.rowspan), av.sprintf(' colspan="%s"', t.colspan), av.sprintf(' data-field="%s"', t.field), 0 === n && o > 0 ? " data-not-first-th" : "", b.length > 0 ? b.join(" ") : "", ">"), a.push(av.sprintf('<div class="th-inner %s">', e.options.sortable && t.sortable ? "sortable".concat("center" === u ? " sortable-center" : "", " both") : ""));
                                var A = e.options.escape && e.options.escapeTitle ? av.escapeHTML(t.title) : t.title,
                                    $ = A;
                                t.checkbox && (A = "", !e.options.singleSelect && e.options.checkboxHeader && (A = '<label><input name="btSelectAll" type="checkbox" /><span></span></label>'), e.header.stateField = t.field), t.radio && (A = "", e.header.stateField = t.field), !A && t.showSelectTitle && (A += $), a.push(A), a.push("</div>"), a.push('<div class="fht-cell"></div>'), a.push("</div>"), a.push("</th>")
                            }
                        })), s && "right" === e.options.detailViewAlign && a.push(s), a.push("</tr>"), a.length > 3 && n.push(a.join(""))
                    ...
                    var o = av.getEventName("resize.bootstrap-table", this.$el.attr("id"));
                ...
                key: "initData",
                value: function(t, e) {
                    "append" === e ? this.options.data = this.options.data.concat(t) : "prepend" === e ? this.options.data = [].concat(t).concat(this.options.data) : (t = t || av.deepCopy(this.options.data), this.options.data = Array.isArray(t) ? t : t[this.options.dataField]), this.data = a(this.options.data), this.options.sortReset && (this.unsortedData = a(this.data)), "server" !== this.options.sidePagination && this.initSort()
                }
            }, {
                key: "initSort",
                value: function() {
                    ...
                    })), this.options.customSort ? av.calculateObjectValue(this.options, this.options.customSort, [this.options.sortName, this.options.sortOrder, this.data]) : this.data.sort((function(o, r) {
                        t.header.sortNames[n] && (e = t.header.sortNames[n]);
                        var a = av.getItemField(o, e, t.options.escape),
                            s = av.getItemField(r, e, t.options.escape),
                            l = av.calculateObjectValue(t.header, t.header.sorters[n], [a, s, o, r]);
                        return void 0 !== l ? t.options.sortStable && 0 === l ? i * (o._position - r._position) : i * l : av.sort(a, s, i, t.options, o._position, r._position)
                ...
                value: function() {
                    ...
                    this.$toolbar.find(".bs-bars").children().length && t("body").append(t(n.toolbar)), this.$toolbar.html(""), "string" != typeof n.toolbar && "object" !== l(n.toolbar) || t(av.sprintf('<div class="bs-bars %s-%s"></div>', this.constants.classes.pull, n.toolbarAlign)).appendTo(this.$toolbar).append(t(n.toolbar)), a = ['<div class="'.concat(["columns", "columns-".concat(n.buttonsAlign), this.constants.classes.buttonsGroup, "".concat(this.constants.classes.pull, "-").concat(n.buttonsAlign)].join(" "), '">')], "string" == typeof n.buttonsOrder && (n.buttonsOrder = n.buttonsOrder.replace(/\[|\]| |'/g, "").split(",")), this.buttons = Object.assign(this.buttons, {
                        ...
                        columns: {
                            ...
                            html: function() {
                                var t = [];
                                if (t.push('<div class="keep-open '.concat(i.constants.classes.buttonsDropdown, '">\n            <button class="').concat(i.constants.buttonsClass, ' dropdown-toggle" type="button" ').concat(i.constants.dataToggle, '="dropdown"\n            aria-label="').concat(n.formatColumns(), '" ').concat(n.buttonsAttributeTitle, '="').concat(n.formatColumns(), '">\n            ').concat(n.showButtonIcons ? av.sprintf(i.constants.html.icon, n.iconsPrefix, n.icons.columns) : "", "\n            ").concat(n.showButtonText ? n.formatColumns() : "", "\n            ").concat(i.constants.html.dropdownCaret, "\n            </button>\n            ").concat(i.constants.html.toolbarDropdown[0])), n.showColumnsSearch && (t.push(av.sprintf(i.constants.html.toolbarDropdownItem, av.sprintf('<input type="text" class="%s" name="columnsSearch" placeholder="%s" autocomplete="off">', i.constants.classes.input, n.formatSearch()))), t.push(i.constants.html.toolbarDropdownSeparator)), n.showColumnsToggleAll) {
                                    var e = i.getVisibleColumns().length === i.columns.filter((function(t) {
                                        return !i.isSelectionColumn(t)
                                    })).length;
                                    t.push(av.sprintf(i.constants.html.toolbarDropdownItem, av.sprintf('<input type="checkbox" class="toggle-all" %s> <span>%s</span>', e ? 'checked="checked"' : "", n.formatColumnsToggleAll()))), t.push(i.constants.html.toolbarDropdownSeparator)
                                }
                                var o = 0;
                                return i.columns.forEach((function(t) {
                                    ...
                                    if (!i.isSelectionColumn(e) && (!n.cardView || e.cardVisible)) {
                                        var a = e.visible ? ' checked="checked"' : "",
                                            s = o <= n.minimumCountColumns && a ? ' disabled="disabled"' : "";
                                        e.switchable && (t.push(av.sprintf(i.constants.html.toolbarDropdownItem, av.sprintf('<input type="checkbox" data-field="%s" value="%s"%s%s> <span>%s</span>', e.field, r, a, s, e.switchableLabel || e.title))), c++)
                                    }
                    ...
                    for (var h = {}, u = 0, d = Object.entries(this.buttons); u < d.length; u++) {
                        ...
                        if (g.hasOwnProperty("html")) "function" == typeof g.html ? v = g.html() : "string" == typeof g.html && (v = g.html);
                            ...
                            v += ">", n.showButtonIcons && g.hasOwnProperty("icon") && (v += "".concat(av.sprintf(this.constants.html.icon, n.iconsPrefix, g.icon), " ")), n.showButtonText && g.hasOwnProperty("text") && (v += g.text), v += "</button>"
                        }
                        h[f] = v;
                        var k = "show".concat(f.charAt(0).toUpperCase()).concat(f.substring(1)),
                            T = n[k];
                        !(!g.hasOwnProperty("render") || g.hasOwnProperty("render") && g.render) || void 0 !== T && !0 !== T || (n[k] = !0), n.buttonsOrder.includes(f) || n.buttonsOrder.push(f)
                    }
                    var C, P = o(n.buttonsOrder);
                    try {
                        for (P.s(); !(C = P.n()).done;) {
                            var I = C.value;
                            n["show".concat(I.charAt(0).toUpperCase()).concat(I.substring(1))] && a.push(h[I])
                        }
                    } catch (t) {
                        P.e(t)
                    } finally {
                    ...
                    for (var A = function() {
                            ...
                            if (n.hasOwnProperty("event")) {
                                if ("function" == typeof n.event || "string" == typeof n.event) {
                                    var o = "string" == typeof n.event ? window[n.event] : n.event;
                                ...
                                for (var a = function() {
                                        var t = r(l[s], 2),
                                            n = t[0],
                                            o = t[1],
                                            a = "string" == typeof o ? window[o] : o;
                                        i.$toolbar.find('button[name="'.concat(e, '"]')).off(n).on(n, (function() {
                                            return a.call(i)
                                        }))
                                    }, s = 0, l = Object.entries(n.event); s < l.length; s++) a()
                            }
                        }, $ = 0, E = Object.entries(this.buttons); $ < E.length; $++) A();
                    if (n.showColumns) {
                        var R = (e = this.$toolbar.find(".keep-open")).find('input[type="checkbox"]:not(".toggle-all")'),
                            j = e.find('input[type="checkbox"].toggle-all');
                        if (c <= n.minimumCountColumns && e.find("input").prop("disabled", !0), e.find("li, label").off("click").on("click", (function(t) {
                                t.stopImmediatePropagation()
                            })), R.off("click").on("click", (function(e) {
                                var n = e.currentTarget,
                                    o = t(n);
                                i._toggleColumn(o.val(), o.prop("checked"), !1), i.trigger("column-switch", o.data("field"), o.prop("checked")), j.prop("checked", R.filter(":checked").length === i.columns.filter((function(t) {
                                    return !i.isSelectionColumn(t)
                                })).length)
                            })), j.off("click").on("click", (function(e) {
                                var n = e.currentTarget;
                                i._toggleAllColumns(t(n).prop("checked")), i.trigger("column-switch-all", t(n).prop("checked"))
                            })), n.showColumnsSearch) {
                            var _ = e.find('[name="columnsSearch"]'),
                                N = e.find(".dropdown-item-marker");
                            _.on("keyup paste change", (function(e) {
                                var i = e.currentTarget,
                                    n = t(i).val().toLowerCase();
                                N.show(), R.each((function(e, i) {
                    ...
                    var F = function(t) {
                        ...
                        t.off(e).on(e, (function(t) {
                            n.searchOnEnterKey && 13 !== t.keyCode || [37, 38, 39, 40].includes(t.keyCode) || (clearTimeout(s), s = setTimeout((function() {
                                i.onSearch({
                    ...
                    if ((n.search || this.showSearchClearButton) && "string" != typeof n.searchSelector) {
                        a = [];
                        var D = av.sprintf(this.constants.html.searchButton, this.constants.buttonsClass, n.formatSearch(), n.showButtonIcons ? av.sprintf(this.constants.html.icon, n.iconsPrefix, n.icons.search) : "", n.showButtonText ? n.formatSearch() : ""),
                            V = av.sprintf(this.constants.html.searchClearButton, this.constants.buttonsClass, n.formatClearSearch(), n.showButtonIcons ? av.sprintf(this.constants.html.icon, n.iconsPrefix, n.icons.clearSearch) : "", n.showButtonText ? n.formatClearSearch() : ""),
                            B = '<input class="'.concat(this.constants.classes.input, "\n        ").concat(av.sprintf(" %s%s", this.constants.classes.inputPrefix, n.iconSize), '\n        search-input" type="search" aria-label="').concat(n.formatSearch(), '" placeholder="').concat(n.formatSearch(), '" autocomplete="off">'),
                            L = B;
                        if (n.showSearchButton || n.showSearchClearButton) {
                            var H = (n.showSearchButton ? D : "") + (n.showSearchClearButton ? V : "");
                            L = n.search ? av.sprintf(this.constants.html.inputGroup, B, H) : H
                        }
                        a.push(av.sprintf('\n        <div class="'.concat(this.constants.classes.pull, "-").concat(n.searchAlign, " search ").concat(this.constants.classes.inputGroup, '">\n          %s\n        </div>\n      '), L)), this.$toolbar.append(a.join(""));
                        var M = av.getSearchInput(this);
                        ...
                        })), n.searchOnEnterKey && F(M)) : F(M), n.showSearchClearButton && this.$toolbar.find(".search button[name=clearSearch]").click((function() {
                            i.resetSearch()
                        }))
                    } else "string" == typeof n.searchSelector && F(av.getSearchInput(this))
                }
            }, {
                key: "onSearch",
                value: function() {
                ...
                value: function() {
                    ...
                    if (this.filterOptions = this.filterOptions || this.options.filterOptions, "server" !== this.options.sidePagination) {
                        if (this.options.customSearch) return this.data = av.calculateObjectValue(this.options, this.options.customSearch, [this.options.data, this.searchText, this.filterColumns]), this.options.sortReset && (this.unsortedData = a(this.data)), void this.initSort();
                        var e = this.searchText && (this.fromHtml ? av.escapeHTML(this.searchText) : this.searchText),
                            i = e ? e.toLowerCase() : "",
                            n = av.isEmptyObject(this.filterColumns) ? null : this.filterColumns;
                        this.options.searchAccentNeutralise && (i = av.normalizeAccent(i)), "function" == typeof this.filterOptions.filterAlgorithm ? this.data = this.options.data.filter((function(e) {
                        ...
                        this.data = i ? this.data.filter((function(n, r) {
                            for (var a = 0; a < t.header.fields.length; a++)
                                if (t.header.searchables[a] && (!t.options.visibleSearch || -1 !== o.indexOf(t.header.fields[a]))) {
                                    var s = av.isNumeric(t.header.fields[a]) ? parseInt(t.header.fields[a], 10) : t.header.fields[a],
                                    ...
                                    if (t.options.searchAccentNeutralise && (c = av.normalizeAccent(c)), l && l.searchFormatter && (c = av.calculateObjectValue(l, t.header.formatters[a], [c, n, r, l.field], c)), "string" == typeof c || "number" == typeof c) {
                                        if (t.options.strictSearch && "".concat(c).toLowerCase() === i || t.options.regexSearch && av.regexCompare(c, e)) return !0;
                    ...
                    if (e.pagination) {
                        ...
                        if (this.paginationParts.includes("pageSize")) {
                            ...
                            d.forEach((function(i, n) {
                                var o;
                                (!e.smartDisplay || 0 === n || d[n - 1] < e.totalRows || i === e.formatAllRows()) && (o = h ? i === e.formatAllRows() ? t.constants.classes.dropdownActive : "" : i === e.pageSize ? t.constants.classes.dropdownActive : "", g.push(av.sprintf(t.constants.html.pageDropdownItem, o, i)))
                        ...
                        if ((this.paginationParts.includes("pageInfo") || this.paginationParts.includes("pageInfoShort") || this.paginationParts.includes("pageSize")) && c.push("</div></div>"), this.paginationParts.includes("pageList")) {
                            c.push('<div class="'.concat(this.constants.classes.pull, "-").concat(e.paginationHAlign, ' pagination">'), av.sprintf(this.constants.html.pagination[0], av.sprintf(" pagination-%s", e.iconSize)), av.sprintf(this.constants.html.paginationItem, " page-pre", e.formatSRPaginationPreText(), e.paginationPreText)), this.totalPages < e.paginationSuccessivelySize ? (n = 1, o = this.totalPages) : o = (n = e.pageNumber - e.paginationPagesBySide) + 2 * e.paginationPagesBySide, e.pageNumber < e.paginationSuccessivelySize - 1 && (o = e.paginationSuccessivelySize), e.paginationSuccessivelySize > this.totalPages - n && (n = n - (e.paginationSuccessivelySize - (this.totalPages - n)) + 1), n < 1 && (n = 1), o > this.totalPages && (o = this.totalPages);
                            var v = Math.round(e.paginationPagesBySide / 2),
                                b = function(i) {
                                    var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "";
                                    return av.sprintf(t.constants.html.paginationItem, n + (i === e.pageNumber ? " ".concat(t.constants.classes.paginationActive) : ""), e.formatSRPaginationPageText(i), i)
                                };
                            if (n > 1) {
                                var m = e.paginationPagesBySide;
                                for (m >= n && (m = n - 1), i = 1; i <= m; i++) c.push(b(i));
                                n - 1 === m + 1 ? (i = n - 1, c.push(b(i))) : n - 1 > m && (n - 2 * e.paginationPagesBySide > e.paginationPagesBySide && e.paginationUseIntermediate ? (i = Math.round((n - v) / 2 + v), c.push(b(i, " page-intermediate"))) : c.push(av.sprintf(this.constants.html.paginationItem, " page-first-separator disabled", "", "...")))
                            }
                            for (i = n; i <= o; i++) c.push(b(i));
                            if (this.totalPages > o) {
                                var y = this.totalPages - (e.paginationPagesBySide - 1);
                                for (o >= y && (y = o + 1), o + 1 === y - 1 ? (i = o + 1, c.push(b(i))) : y > o + 1 && (this.totalPages - o > 2 * e.paginationPagesBySide && e.paginationUseIntermediate ? (i = Math.round((this.totalPages - v - o) / 2 + o), c.push(b(i, " page-intermediate"))) : c.push(av.sprintf(this.constants.html.paginationItem, " page-last-separator disabled", "", "..."))), i = y; i <= this.totalPages; i++) c.push(b(i))
                            }
                            c.push(av.sprintf(this.constants.html.paginationItem, " page-next", e.formatSRPaginationNextText(), e.paginationNextText)), c.push(this.constants.html.pagination[1], "</div>")
                        }
                ...
                value: function(t, e, i, n) {
                    var o = this,
                        ...
                        u = {},
                        d = [];
                    if (!(av.findIndex(this.hiddenRows, t) > -1)) {
                        if ((s = av.calculateObjectValue(this.options, this.options.rowStyle, [t, e], s)) && s.css)
                            for (var p = 0, f = Object.entries(s.css); p < f.length; p++) {
                                var g = r(f[p], 2),
                                    v = g[0],
                                    b = g[1];
                                c.push("".concat(v, ": ").concat(b))
                            }
                        if (u = av.calculateObjectValue(this.options, this.options.rowAttributes, [t, e], u))
                            for (var m = 0, y = Object.entries(u); m < y.length; m++) {
                                var w = r(y[m], 2),
                                    S = w[0],
                                    x = w[1];
                                d.push("".concat(S, '="').concat(av.escapeHTML(x), '"'))
                            }
                        if (t._data && !av.isEmptyObject(t._data))
                            for (var O = 0, k = Object.entries(t._data); O < k.length; O++) {
                                var T = r(k[O], 2),
                                    C = T[0],
                                    P = T[1];
                                if ("index" === C) return;
                                h += " data-".concat(C, "='").concat("object" === l(P) ? JSON.stringify(P) : P, "'")
                            }
                        a.push("<tr", av.sprintf(" %s", d.length ? d.join(" ") : void 0), av.sprintf(' id="%s"', Array.isArray(t) ? void 0 : t._id), av.sprintf(' class="%s"', s.classes || (Array.isArray(t) ? void 0 : t._class)), av.sprintf(' style="%s"', Array.isArray(t) ? void 0 : t._style), ' data-index="'.concat(e, '"'), av.sprintf(' data-uniqueid="%s"', av.getItemField(t, this.options.uniqueId, !1)), av.sprintf(' data-has-detail-view="%s"', this.options.detailView && av.calculateObjectValue(null, this.options.detailFilter, [e, t]) ? "true" : void 0), av.sprintf("%s", h), ">"), this.options.cardView && a.push('<td colspan="'.concat(this.header.fields.length, '"><div class="card-views">'));
                        var I = "";
                        return av.hasDetailViewIcon(this.options) && (I = "<td>", av.calculateObjectValue(null, this.options.detailFilter, [e, t]) && (I += '\n          <a class="detail-icon" href="#">\n          '.concat(av.sprintf(this.constants.html.icon, this.options.iconsPrefix, this.options.icons.detailOpen), "\n          </a>\n        ")), I += "</td>"), I && "right" !== this.options.detailViewAlign && a.push(I), this.header.fields.forEach((function(i, n) {
                            var s = o.columns[n],
                                l = "",
                                h = av.getItemField(t, i, o.options.escape, s.escape),
                                u = "",
                                d = "",
                                p = {},
                                f = "",
                                g = o.header.classes[n],
                                v = "",
                                b = "",
                                m = "",
                                y = "",
                                w = "",
                                S = "";
                            if ((!o.fromHtml && !o.autoMergeCells || void 0 !== h || s.checkbox || s.radio) && s.visible && (!o.options.cardView || s.cardVisible)) {
                                if (c.concat([o.header.styles[n]]).length && (b += "".concat(c.concat([o.header.styles[n]]).join("; "))), t["_".concat(i, "_style")] && (b += "".concat(t["_".concat(i, "_style")])), b && (v = ' style="'.concat(b, '"')), t["_".concat(i, "_id")] && (f = av.sprintf(' id="%s"', t["_".concat(i, "_id")])), t["_".concat(i, "_class")] && (g = av.sprintf(' class="%s"', t["_".concat(i, "_class")])), t["_".concat(i, "_rowspan")] && (y = av.sprintf(' rowspan="%s"', t["_".concat(i, "_rowspan")])), t["_".concat(i, "_colspan")] && (w = av.sprintf(' colspan="%s"', t["_".concat(i, "_colspan")])), t["_".concat(i, "_title")] && (S = av.sprintf(' title="%s"', t["_".concat(i, "_title")])), (p = av.calculateObjectValue(o.header, o.header.cellStyles[n], [h, t, e, i], p)).classes && (g = ' class="'.concat(p.classes, '"')), p.css) {
                                    for (var x = [], O = 0, k = Object.entries(p.css); O < k.length; O++) {
                                        var T = r(k[O], 2),
                                            C = T[0],
                                            P = T[1];
                                        x.push("".concat(C, ": ").concat(P))
                                    }
                                    v = ' style="'.concat(x.concat(o.header.styles[n]).join("; "), '"')
                                }
                                if (u = av.calculateObjectValue(s, o.header.formatters[n], [h, t, e, i], h), s.checkbox || s.radio || (u = null == u ? o.options.undefinedText : u), s.searchable && o.searchText && o.options.searchHighlight && !s.checkbox && !s.radio) {
                                    var I = o.searchText.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
                                    if (o.options.searchAccentNeutralise) {
                                        var A = new RegExp("".concat(av.normalizeAccent(I)), "gmi").exec(av.normalizeAccent(u));
                                        A && (I = u.substring(A.index, A.index + I.length))
                                    }
                                    var $ = av.replaceSearchMark(u, I);
                                    u = av.calculateObjectValue(s, s.searchHighlightFormatter, [u, o.searchText], $)
                                }
                                if (t["_".concat(i, "_data")] && !av.isEmptyObject(t["_".concat(i, "_data")]))
                                    for (var E = 0, R = Object.entries(t["_".concat(i, "_data")]); E < R.length; E++) {
                                        var j = r(R[E], 2),
                                            _ = j[0],
                                            N = j[1];
                                        if ("index" === _) return;
                                        m += " data-".concat(_, '="').concat(N, '"')
                                    }
                                if (s.checkbox || s.radio) {
                                    d = s.checkbox ? "checkbox" : d, d = s.radio ? "radio" : d;
                                    var F = s.class || "",
                                        D = av.isObject(u) && u.hasOwnProperty("checked") ? u.checked : (!0 === u || h) && !1 !== u,
                                        V = !s.checkboxEnabled || u && u.disabled;
                                    l = [o.options.cardView ? '<div class="card-view '.concat(F, '">') : '<td class="bs-checkbox '.concat(F, '"').concat(g).concat(v, ">"), '<label>\n            <input\n            data-index="'.concat(e, '"\n            name="').concat(o.options.selectItemName, '"\n            type="').concat(d, '"\n            ').concat(av.sprintf('value="%s"', t[o.options.idField]), "\n            ").concat(av.sprintf('checked="%s"', D ? "checked" : void 0), "\n            ").concat(av.sprintf('disabled="%s"', V ? "disabled" : void 0), " />\n            <span></span>\n            </label>"), o.header.formatters[n] && "string" == typeof u ? u : "", o.options.cardView ? "</div>" : "</td>"].join(""), t[o.header.stateField] = !0 === u || !!h || u && u.checked
                                } else if (o.options.cardView) {
                                    var B = o.options.showHeader ? '<span class="card-view-title '.concat(p.classes || "", '"').concat(v, ">").concat(av.getFieldTitle(o.columns, i), "</span>") : "";
                                    l = '<div class="card-view">'.concat(B, '<span class="card-view-value ').concat(p.classes || "", '"').concat(v, ">").concat(u, "</span></div>"), o.options.smartDisplay && "" === u && (l = '<div class="card-view"></div>')
                                } else l = "<td".concat(f).concat(g).concat(v).concat(m).concat(y).concat(w).concat(S, ">").concat(u, "</td>");
                                a.push(l)
                            }
                        })), I && "right" === this.options.detailViewAlign && a.push(I), this.options.cardView && a.push("</div></td>"), a.push("</tr>"), a.join("")
                    }
                }
            }, {
                key: "initBody",
                value: function(e, i) {
                    ...
                    var r = [],
                        ...
                        s = !1,
                        l = [];
                    this.autoMergeCells = av.checkAutoMergeCells(o.slice(this.pageFrom - 1, this.pageTo));
                    for (var c = this.pageFrom - 1; c < this.pageTo; c++) {
                        ...
                        if (s = s || !!u, u && "string" == typeof u) {
                            ...
                            if (d && h.hasOwnProperty(d)) {
                                var p = h[d],
                                    f = this.$body.find(av.sprintf('> tr[data-uniqueid="%s"][data-has-detail-view]', p)).next();
                    ...
                    })) : this.$body.html(a) : this.$body.html('<tr class="no-records-found">'.concat(av.sprintf('<td colspan="%s">%s</td>', this.getVisibleFields().length + av.getDetailViewIndexOffset(this.options), this.options.formatNoMatches()), "</tr>")), l.forEach((function(t) {
                        n.expandRow(t)
                ...
                value: function() {
                    ...
                    this.$body.find("> tr[data-index] > td").off("click dblclick").on("click dblclick", (function(i) {
                        var n = t(i.currentTarget);
                        if (!(n.find(".detail-icon").length || n.index() - av.getDetailViewIndexOffset(e.options) < 0)) {
                            var o = n.parent(),
                                ...
                                h = e.getVisibleFields()[c - av.getDetailViewIndexOffset(e.options)],
                                u = e.columns[e.fieldsColumnsIndex[h]],
                                d = av.getItemField(l, h, e.options.escape, u.escape);
                            if (e.trigger("click" === i.type ? "click-cell" : "dbl-click-cell", h, d, l, n), e.trigger("click" === i.type ? "click-row" : "dbl-click-row", l, o, h), "click" === i.type && e.options.clickToSelect && u.clickToSelect && !av.calculateObjectValue(e.options, e.options.ignoreClickToSelectOn, [i.target])) {
                                var p = o.find(av.sprintf('[name="%s"]', e.options.selectItemName));
                                p.length && p[0].click()
                            }
                    ...
                    })), this.$selectItem = this.$body.find(av.sprintf('[name="%s"]', this.options.selectItemName)), this.$selectItem.off("click").on("click", (function(i) {
                        ...
                        var o = i;
                        if (o) {
                            if ("string" == typeof o && (o = av.calculateObjectValue(null, o)), !o) throw new Error("Unknown event in the scope: ".concat(i));
                            var r = e.header.fields[n],
                                a = e.getVisibleFields().indexOf(r);
                            if (-1 !== a) {
                                a += av.getDetailViewIndexOffset(e.options);
                                var s = function(i) {
                ...
                value: function(e, i, n) {
                    ...
                    if (this.header.sortNames[s] && (l.sortName = this.header.sortNames[s]), this.options.pagination && "server" === this.options.sidePagination && (l.pageSize = this.options.pageSize === this.options.formatAllRows() ? this.options.totalRows : this.options.pageSize, l.pageNumber = this.options.pageNumber), n || this.options.url || this.options.ajax) {
                        if ("limit" === this.options.queryParamsType && (l = {
                                search: l.searchText,
                                sort: l.sortName,
                                order: l.sortOrder
                            }, this.options.pagination && "server" === this.options.sidePagination && (l.offset = this.options.pageSize === this.options.formatAllRows() ? 0 : this.options.pageSize * (this.options.pageNumber - 1), l.limit = this.options.pageSize, 0 !== l.limit && this.options.pageSize !== this.options.formatAllRows() || delete l.limit)), this.options.search && "server" === this.options.sidePagination && this.options.searchable && this.columns.filter((function(t) {
                                return t.searchable
                            })).length) {
                            l.searchable = [];
                            var c, h = o(this.columns);
                            try {
                                for (h.s(); !(c = h.n()).done;) {
                                    var u = c.value;
                                    !u.checkbox && u.searchable && (this.options.visibleSearch && u.visible || !this.options.visibleSearch) && l.searchable.push(u.field)
                                }
                            } catch (t) {
                                h.e(t)
                            } finally {
                        ...
                        if (av.isEmptyObject(this.filterColumnsPartial) || (l.filter = JSON.stringify(this.filterColumnsPartial, null)), av.extend(l, i || {}), !1 !== (a = av.calculateObjectValue(this.options, this.options.queryParams, [l], a))) {
                            e || this.showLoading();
                            var d = av.extend({}, av.calculateObjectValue(null, this.options.ajaxOptions), {
                                ...
                                success: function(t, i, n) {
                                    var o = av.calculateObjectValue(r.options, r.options.responseHandler, [t, n], t);
                                    "client" === r.options.sidePagination && r.options.paginationLoadMore && (r._paginationLoaded = r.data.length === o.length), r.load(o), r.trigger("load-success", o, n && n.status, n), e || r.hideLoading(), "server" === r.options.sidePagination && r.options.pageNumber > 1 && o[r.options.totalField] > 0 && !o[r.options.dataField].length && r.updatePagination()
                                },
                                error: function(t) {
                                    if (t && 0 === t.status && r._xhrAbort) r._xhrAbort = !1;
                                    else {
                                        var i = [];
                                        "server" === r.options.sidePagination && ((i = {})[r.options.totalField] = 0, i[r.options.dataField] = []), r.load(i), r.trigger("load-error", t && t.status, t), e || r.hideLoading()
                                    }
                                }
                            });
                            return this.options.ajax ? av.calculateObjectValue(this, this.options.ajax, [d], null) : (this._xhr && 4 !== this._xhr.readyState && (this._xhrAbort = !0, this._xhr.abort()), this._xhr = t.ajax(d)), a
                        }
                    }
                }
            }, {
                ...
                value: function() {
                    ...
                    if (this.$el.is(":hidden")) this.timeoutId_ = setTimeout((function() {
                        ...
                        var i = this.$tableBody.get(0),
                            n = this.hasScrollBar && i.scrollHeight > i.clientHeight + this.$header.outerHeight() ? av.getScrollBarWidth() : 0;
                        ...
                        l.length > 0 && (l.focus(), this.$header.find(".focus-temp").removeClass("focus-temp")), this.$header.find("th[data-field]").each((function(i, n) {
                            e.$header_.find(av.sprintf('th[data-field="%s"]', t(n).data("field"))).data(t(n).data())
                        }));
                        ...
                        u.find("> *").each((function(i, n) {
                            var o = t(n);
                            if (av.hasDetailViewIcon(e.options) && (0 === i && "right" !== e.options.detailViewAlign || i === d - 1 && "right" === e.options.detailViewAlign)) {
                                var r = h.filter(".detail"),
                                    a = r.innerWidth() - r.find(".fht-cell").width();
                                r.find(".fht-cell").width(o.innerWidth() - a)
                            } else {
                                var s = i - av.getDetailViewIndexOffset(e.options),
                                    l = e.$header_.find(av.sprintf('th[data-field="%s"]', c[s]));
                ...
                value: function() {
                    if (this.options.showFooter && !this.options.cardView) {
                        var t = this.getData(),
                            e = [],
                            i = "";
                        av.hasDetailViewIcon(this.options) && (i = '<th class="detail"><div class="th-inner"></div><div class="fht-cell"></div></th>'), i && "right" !== this.options.detailViewAlign && e.push(i);
                        var n, a = o(this.columns);
                        try {
                            for (a.s(); !(n = a.n()).done;) {
                                var s, l, c = n.value,
                                    h = [],
                                    u = {},
                                    d = av.sprintf(' class="%s"', c.class);
                                if (!(!c.visible || this.footerData && this.footerData.length > 0 && !(c.field in this.footerData[0]))) {
                                    if (this.options.cardView && !c.cardVisible) return;
                                    if (s = av.sprintf("text-align: %s; ", c.falign ? c.falign : c.align), l = av.sprintf("vertical-align: %s; ", c.valign), (u = av.calculateObjectValue(null, c.footerStyle || this.options.footerStyle, [c])) && u.css)
                                    ...
                                    u && u.classes && (d = av.sprintf(' class="%s"', c.class ? [c.class, u.classes].join(" ") : u.classes)), e.push("<th", d, av.sprintf(' style="%s"', s + l + h.concat().join("; ") || void 0));
                                    var m = 0;
                                    this.footerData && this.footerData.length > 0 && (m = this.footerData[0]["_".concat(c.field, "_colspan")] || 0), m && e.push(' colspan="'.concat(m, '" ')), e.push(">"), e.push('<div class="th-inner">');
                                    var y = "";
                                    this.footerData && this.footerData.length > 0 && (y = this.footerData[0][c.field] || ""), e.push(av.calculateObjectValue(c, c.footerFormatter, [t, y], y)), e.push("</div>"), e.push('<div class="fht-cell"></div>'), e.push("</div>"), e.push("</th>")
                                }
                            }
                        } catch (t) {
                            a.e(t)
                ...
                value: function() {
                    ...
                    if (this.$el.is(":hidden")) setTimeout((function() {
                        ...
                        r.find("> *").each((function(i, n) {
                            var r = t(n);
                            if (av.hasDetailViewIcon(e.options) && (0 === i && "left" === e.options.detailViewAlign || i === a - 1 && "right" === e.options.detailViewAlign)) {
                ...
                value: function() {
                    ...
                    try {
                        for (i.s(); !(t = i.n()).done;) {
                            ...
                            r && r.visible && (!this.options.cardView || r.cardVisible) && e.push(n)
                        }
                    } catch (t) {
                        i.e(t)
                    } finally {
                ...
                key: "getOptions",
                value: function() {
                    var t = av.extend({}, this.options);
                    return delete t.data, av.extend(!0, {}, t)
                }
            }, {
                key: "refreshOptions",
                value: function(t) {
                    av.compareObjects(this.options, t, !0) || (this.options = av.extend(this.options, t), this.trigger("refresh-options", this.options), this.destroy(), this.init())
                }
            }, {
                key: "getData",
                value: function(t) {
                    var e = this,
                        i = this.options.data;
                    if (!(this.searchText || this.options.customSearch || void 0 !== this.options.sortName || this.enableCustomSort) && av.isEmptyObject(this.filterColumns) && "function" != typeof this.options.filterOptions.filterAlgorithm && av.isEmptyObject(this.filterColumnsPartial) || t && t.unfiltered || (i = this.data), t && !t.includeHiddenRows) {
                        var n = this.getHiddenRows();
                        i = i.filter((function(t) {
                            return -1 === av.findIndex(n, t)
                        }))
                    }
                    return t && t.useCurrentPage && (i = i.slice(this.pageFrom - 1, this.pageTo)), t && t.formatted ? i.map((function(t) {
                        for (var i = 0, n = Object.entries(t); i < n.length; i++) {
                            ...
                            if (l) return av.calculateObjectValue(l, e.header.formatters[l.fieldIndex], [s, t, t.index, l.field], s)
                        }
                    })) : i
                }
            }, {
                ...
                value: function(t) {
                    for (var e = 0, i = this.options.data.length - 1; i >= 0; i--) {
                        var n = this.options.data[i],
                            o = av.getItemField(n, t.field, this.options.escape, n.escape);
                ...
                value: function(t) {
                    if (t.hasOwnProperty("index") && t.hasOwnProperty("row")) {
                        ...
                        this.data.splice(t.index, 0, t.row), this.options.data.splice(i, 0, t.row), this.initSearch(), this.initPagination(), this.initSort(), this.initBody(!0)
                    }
                }
            }, {
                key: "updateRow",
                value: function(t) {
                    var e, i = o(Array.isArray(t) ? t : [t]);
                    try {
                        for (i.s(); !(e = i.n()).done;) {
                            var n = e.value;
                            if (n.hasOwnProperty("index") && n.hasOwnProperty("row")) {
                                ...
                                n.hasOwnProperty("replace") && n.replace ? (this.data[n.index] = n.row, this.options.data[a] = n.row) : (av.extend(this.data[n.index], n.row), av.extend(this.options.data[a], n.row))
                            }
                        }
                    } catch (t) {
                        i.e(t)
                ...
                value: function(t) {
                    ...
                    for (e = this.options.data.length - 1; e >= 0; e--) {
                        ...
                        var a = av.getItemField(i, n, this.options.escape, i.escape);
                        if (void 0 !== a && ("string" == typeof a ? o = t.toString() : "number" == typeof a && (Number(a) === a && a % 1 == 0 ? o = parseInt(t, 10) : a === Number(a) && 0 !== a && (o = parseFloat(t))), a === o)) {
                            r = i;
                            break
                        }
                    }
                    ...
                    try {
                        for (n.s(); !(e = n.n()).done;) {
                            ...
                            if (r.hasOwnProperty("id") && r.hasOwnProperty("row")) {
                                var a = this.options.data.indexOf(this.getRowByUniqueId(r.id)); - 1 !== a && (r.hasOwnProperty("replace") && r.replace ? this.options.data[a] = r.row : av.extend(this.options.data[a], r.row), i = r.id)
                            }
                        }
                    } catch (t) {
                        n.e(t)
                ...
                value: function(e, i) {
                    var n = this.initRow(this.data[i], i),
                        o = this.getVisibleFields().indexOf(e); - 1 !== o && (o += av.getDetailViewIndexOffset(this.options), this.$body.find(">tr[data-index=".concat(i, "]")).find(">td:eq(".concat(o, ")")).replaceWith(t(n).find(">td:eq(".concat(o, ")"))), this.initBodyEvent(), this.initFooter(), this.resetView(), this.updateSelected())
                }
            }, {
                key: "updateCell",
                value: function(t) {
                    if (t.hasOwnProperty("index") && t.hasOwnProperty("field") && t.hasOwnProperty("value")) {
                        var e = this.data[t.index],
                            i = this.options.data.indexOf(e);
                        this.data[t.index][t.field] = t.value, this.options.data[i][t.field] = t.value, !1 !== t.reinit ? (this.initSort(), this.initBody(!0)) : this._updateCellOnly(t.field, t.index)
                    }
                }
            }, {
                ...
                value: function(t, e) {
                    ...
                    if (t.hasOwnProperty("index") ? i = this.getData()[t.index] : t.hasOwnProperty("uniqueId") && (i = this.getRowByUniqueId(t.uniqueId)), i) {
                        var n = av.findIndex(this.hiddenRows, i);
                ...
                value: function(t, e, i) {
                    if (void 0 !== t && this.columns[t].visible !== e && (this.columns[t].visible = e, this.initHeader(), this.initSearch(), this.initPagination(), this.initBody(), this.options.showColumns)) {
                        ...
                        i && n.filter(av.sprintf('[value="%s"]', t)).prop("checked", e), n.filter(":checked").length <= this.options.minimumCountColumns && n.filter(":checked").prop("disabled", !0)
                    }
                }
            }, {
                ...
                value: function(e) {
                    ...
                    if (this.initHeader(), this.initSearch(), this.initPagination(), this.initBody(), this.options.showColumns) {
                        ...
                        e ? s.prop("checked", e) : s.get().reverse().forEach((function(i) {
                            s.filter(":checked").length > n.options.minimumCountColumns && t(i).prop("checked", e)
                ...
                value: function(t) {
                    ...
                    o += av.getDetailViewIndexOffset(this.options);
                ...
                value: function(t, e) {
                    ...
                    if (i.is(":radio") || this.options.singleSelect || this.options.multipleSelectRow && !this.multipleSelectRowCtrlKey && !this.multipleSelectRowShiftKey) {
                        var a, s = o(this.options.data);
                        try {
                            for (s.s(); !(a = s.n()).done;) {
                                a.value[this.header.stateField] = !1
                            }
                        } catch (t) {
                            s.e(t)
                        } finally {
                    ...
                    if (n[this.header.stateField] = t, this.options.multipleSelectRow) {
                        if (this.multipleSelectRowShiftKey && this.multipleSelectRowLastSelectedIndex >= 0)
                            for (var l = r(this.multipleSelectRowLastSelectedIndex < e ? [this.multipleSelectRowLastSelectedIndex, e] : [e, this.multipleSelectRowLastSelectedIndex], 2), c = l[0], h = l[1], u = c + 1; u < h; u++) this.data[u][this.header.stateField] = !0, this.$selectItem.filter('[data-index="'.concat(u, '"]')).prop("checked", !0);
                    ...
                    if (e.hasOwnProperty("field") && e.hasOwnProperty("values")) {
                        ...
                        this.data.forEach((function(o, r) {
                            ...
                            if (e.values.includes(o[e.field])) {
                                var a = i.$selectItem.filter(":enabled").filter(av.sprintf('[data-index="%s"]', r)),
                ...
                value: function() {
                    ...
                    var e = av.getEventName("resize.bootstrap-table", this.$el.attr("id"));
                    t(window).off(e)
                }
            }, {
                key: "resetView",
                value: function(t) {
                    ...
                    if (!this.options.cardView && this.options.showHeader && this.options.height ? (this.$tableHeader.show(), this.resetHeader(), e += this.$header.outerHeight(!0) + 1) : (this.$tableHeader.hide(), this.trigger("post-header")), !this.options.cardView && this.options.showFooter && (this.$tableFooter.show(), this.fitFooter(), this.options.height && (e += this.$tableFooter.outerHeight(!0))), this.$container.hasClass("fullscreen")) this.$tableContainer.css("height", ""), this.$tableContainer.css("width", "");
                        ...
                        if (this.$tableContainer.css("height", "".concat(r, "px")), this.$tableBorder && a.is(":visible")) {
                            var l = r - s - 2;
                            this.hasScrollBar && (l -= av.getScrollBarWidth()), this.$tableBorder.css("width", "".concat(a.outerWidth(), "px")), this.$tableBorder.css("height", "".concat(l, "px"))
                        }
                    }
                ...
                value: function() {
                    ...
                    this.$toolbar.find('button[name="paginationSwitch"]').html("".concat(av.sprintf(this.constants.html.icon, this.options.iconsPrefix, t), " ").concat(e)), this.updatePagination(), this.trigger("toggle-pagination", this.options.pagination)
                }
            }, {
                ...
                value: function() {
                    ...
                    this.$toolbar.find('button[name="toggle"]').html("".concat(av.sprintf(this.constants.html.icon, this.options.iconsPrefix, t), " ").concat(this.options.showButtonText ? e : "")).attr("aria-label", e).attr(this.options.buttonsAttributeTitle, e), this.initBody(), this.trigger("toggle", this.options.cardView)
                }
            }, {
                key: "resetSearch",
                value: function(t) {
                    var e = av.getSearchInput(this),
                        i = t || "";
                ...
                key: "filterBy",
                value: function(t, e) {
                    this.filterOptions = av.isEmptyObject(e) ? this.options.filterOptions : av.extend(this.options.filterOptions, e), this.filterColumns = av.isEmptyObject(t) ? {} : t, this.options.pageNumber = 1, this.initSearch(), this.updatePagination()
                }
            }, {
                key: "scrollTo",
                value: function(e) {
                    ...
                    "object" === l(e) ? i = Object.assign(i, e) : "string" == typeof e && "bottom" === e ? i.value = this.$tableBody[0].scrollHeight : "string" != typeof e && "number" != typeof e || (i.value = e);
                    var n = i.value;
                ...
                value: function(t, e) {
                    this.$body.find(av.sprintf('> tr[data-index="%s"]', t)).next().is("tr.detail-view") ? this.collapseRow(t) : this.expandRow(t, e), this.resetView()
                }
            }, {
                key: "expandRow",
                value: function(t, e) {
                    var i = this.data[t],
                        n = this.$body.find(av.sprintf('> tr[data-index="%s"][data-has-detail-view]', t));
                    if (this.options.detailViewIcon && n.find("a.detail-icon").html(av.sprintf(this.constants.html.icon, this.options.iconsPrefix, this.options.icons.detailClose)), !n.next().is("tr.detail-view")) {
                        n.after(av.sprintf('<tr class="detail-view"><td colspan="%s"></td></tr>', n.children("td").length));
                        var o = n.next().find("td"),
                            r = e || this.options.detailFormatter,
                            a = av.calculateObjectValue(this.options, r, [t, i, o], "");
                ...
                value: function(t) {
                    var e = this.data[t],
                        i = this.$body.find(av.sprintf('> tr[data-index="%s"][data-has-detail-view]', t));
                    i.next().is("tr.detail-view") && (this.options.detailViewIcon && i.find("a.detail-icon").html(av.sprintf(this.constants.html.icon, this.options.iconsPrefix, this.options.icons.detailOpen)), this.trigger("collapse-row", t, e, i.next()), i.next().remove())
                }
            }, {
                ...
                value: function(e) {
                    e.hasOwnProperty("field") && e.hasOwnProperty("title") && (this.columns[this.fieldsColumnsIndex[e.field]].title = this.options.escape && this.options.escapeTitle ? av.escapeHTML(e.title) : e.title, this.columns[this.fieldsColumnsIndex[e.field]].visible && (this.$header.find("th[data-field]").each((function(i, n) {
                        if (t(n).data("field") === e.field) return t(t(n).find(".th-inner")[0]).html(e.title), !1
                    })), this.resetView()))
                }
            }, {
    ...
    return fv.VERSION = dv.VERSION, fv.DEFAULTS = dv.DEFAULTS, fv.LOCALES = dv.LOCALES, fv.COLUMN_DEFAULTS = dv.COLUMN_DEFAULTS, fv.METHODS = dv.METHODS, fv.EVENTS = dv.EVENTS, t.BootstrapTable = fv, t.fn.bootstrapTable = function(e) {
        ...
        return this.each((function(i, o) {
            ...
            if ("string" == typeof e) {
                var s;
                if (!dv.METHODS.includes(e)) throw new Error("Unknown method: ".concat(e));
                if (!a) return;
                return r = (s = a)[e].apply(s, n), void("destroy" === e && t(o).removeData("bootstrap.table"))
            }
            if (a) console.warn("You cannot initialize the table more than once!");
            else {
                var c = av.extend(!0, {}, fv.DEFAULTS, t(o).data(), "object" === l(e) && e);
                a = new t.BootstrapTable(o, c), t(o).data("bootstrap.table", a), a.init()
            }
        })), void 0 === r ? this : r
    }, t.fn.bootstrapTable.Constructor = fv, t.fn.bootstrapTable.theme = dv.THEME, t.fn.bootstrapTable.VERSION = dv.VERSION, t.fn.bootstrapTable.defaults = fv.DEFAULTS, t.fn.bootstrapTable.columnDefaults = fv.COLUMN_DEFAULTS, t.fn.bootstrapTable.events = fv.EVENTS, t.fn.bootstrapTable.locales = fv.LOCALES, t.fn.bootstrapTable.methods = fv.METHODS, t.fn.bootstrapTable.utils = av, t((function() {
