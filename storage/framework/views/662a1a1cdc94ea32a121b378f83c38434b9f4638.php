                            ...
                            <div class="row">
                                <div class="col">
                                    <select name="filter_class_section_id" id="filter_class_section_id"
                                        ...
                                        <?php $__currentLoopData = $classSchools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classSchool): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($classSchool->id); ?>"><?php echo e($classSchool->name); ?> -
                                                <?php echo e($classSchool->medium->name); ?>

                                                <?php echo e($classSchool->streams->name ?? ' '); ?></option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <table aria-describedby="mydesc" class='table table-responsive' id='table_list'
                                    data-toggle="table" data-url="<?php echo e(url('online-registration-list')); ?>"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" data-field="class_id" data-sortable="false"data-visible="false"><?php echo e(__('class') . ' ' . __('section') . ' ' . __('id')); ?></th>
                                            <th scope="col" data-field="class_name" data-sortable="false"><?php echo e(__('class')); ?></th>
                                            <th scope="col" data-field="category_id" data-sortable="false"data-visible="false"><?php echo e(__('category') . ' ' . __('id')); ?></th>
                                            <th scope="col" data-field="category_name" data-sortable="false" data-visible="false"><?php echo e(__('category')); ?></th>
                                            <th scope="col" data-field="admission_date" data-sortable="false"><?php echo e(__('admission_date')); ?></th>
                                            <th scope="col" data-field="father_first_name" data-sortable="false"> <?php echo e(__('father') . ' ' . __('name')); ?></th>
                                            <th scope="col" data-field="father_mobile" data-sortable="false"><?php echo e(__('father') . ' ' . __('mobile')); ?></th>
                                            <th scope="col" data-field="father_occupation" data-sortable="false" data-visible="false"><?php echo e(__('father') . ' ' . __('occupation')); ?></th>
                                            <th scope="col" data-field="father_image" data-sortable="false" data-formatter="fatherImageFormatter"><?php echo e(__('father') . ' ' . __('image')); ?></th>
                                            <th scope="col" data-field="mother_first_name" data-sortable="false"><?php echo e(__('mother') . ' ' . __('name')); ?></th>
                                            <th scope="col" data-field="mother_occupation" data-sortable="false" data-visible="false"><?php echo e(__('parents') . ' ' . __('occupation')); ?></th>
                                            <th scope="col" data-field="mother_image" data-sortable="false" data-formatter="motherImageFormatter"><?php echo e(__('mother') . ' ' . __('image')); ?></th>
                                            <th scope="col" data-field="guardian_first_name" data-sortable="false"><?php echo e(__('guardian') . ' ' . __('name')); ?></th>
                                            <th scope="col" data-field="guardian_mobile" data-sortable="false"><?php echo e(__('guardian') . ' ' . __('mobile')); ?></th>
                                            <th scope="col" data-field="guardian_occupation" data-sortable="false" data-visible="false"><?php echo e(__('guardian') . ' ' . __('occupation')); ?></th>
                                            <th scope="col" data-field="guardian_image" data-sortable="false" data-formatter="guardianImageFormatter"><?php echo e(__('guardian') . ' ' . __('image')); ?></th>
                                            <th scope="col" data-field="is_new_admission" data-sortable="false" data-visible="false"><?php echo e(__('is_new_admission')); ?></th>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form id="create-form" class="edit-student-registration-form" novalidate="novalidate"
                        action="<?php echo e(route('update-active-status')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <select name="class_id" class="form-control" id="edit_class_id" required>
                                        <option value=""><?php echo e(__('select') . ' ' . __('class')); ?>
                                ...
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <?php echo Form::text('admission_no', null, [
                                ...
                                <div class="form-group col-sm-12 col-md-6">
                                    ...
                                    <?php echo Form::text('admission_date', null, [
                            ...
                            <div class="row">
                                <?php $__currentLoopData = $formFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($row->type === 'text' || $row->type === 'number'): ?>
                                        <div class="form-group col-sm-12 col-md-4">
                                            <label><?php echo e(ucwords(str_replace('_', ' ', $row->name))); ?>

                                                <?php echo $row->is_required ? ' <span class="text-danger">*</span></label>' : ''; ?></label></label>
                                            <input type="<?php echo e($row->type); ?>" name="<?php echo e($row->name); ?>"
                                                id="<?php echo e($row->name); ?>"
                                                placeholder="<?php echo e(ucwords(str_replace('_', ' ', $row->name))); ?>"
                                                class="form-control edit_text_number"
                                                <?php echo e($row->is_required === 1 ? 'required' : ''); ?>>
                                        </div>
                                    <?php endif; ?>
                                    <?php if($row->type === 'dropdown'): ?>
                                        <div class="form-group col-sm-12 col-md-4">
                                            <label><?php echo e(ucwords(str_replace('_', ' ', $row->name))); ?>
                                                ...
                                                <?php echo $row->is_required ? ' <span class="text-danger">*</span></label>' : ''; ?></label></label>
                                            <select name="<?php echo e($row->name); ?>" class="form-control edit_dropdown"
                                                id="<?php echo e($row->name); ?>" <?php echo e($row->is_required === 1 ? 'required' : ''); ?>>
                                                        ...
                                                        <div class="form-check form-check-inline">
                                                            <label class="form-check-label">
                                                                <input type="radio" class="edit_radio"
                                                                    id="<?php echo e($options); ?>" name="<?php echo e($row->name); ?>"
                                                                    value="<?php echo e($options); ?>"
                                                                    <?php echo e($row->is_required === 1 ? 'required' : ''); ?>>
                                    ...
                                    <?php if($row->type === 'checkbox'): ?>
                                        <div class="form-group col-sm-12 col-md-4">
                                            <label><?php echo e(ucwords(str_replace('_', ' ', $row->name))); ?>
                                                ...
                                                <?php echo $row->is_required ? ' <span class="text-danger">*</span></label>' : ''; ?></label>
                                            <br>
                                                        ...
                                                        <div class="checkbox form-check form-check-inline">
                                                            <label class="form-check-label">
                                                                <input type="checkbox" class="edit_checkbox"
                                                                    id="checkbox_<?php echo e($options); ?>"
                                                                    name="<?php echo e('checkbox[' . $row->name . '][' . $options . ']'); ?>"
                                                                    value="<?php echo e($options); ?>">
                                                                <?php echo e(ucfirst(str_replace('_', ' ', $options))); ?>
                                    ...
                                    <?php if($row->type === 'textarea'): ?>
                                        <div class="form-group col-sm-12 col-md-4">
                                            <label><?php echo e(ucwords(str_replace('_', ' ', $row->name))); ?>
                                                ...
                                                <?php echo $row->is_required ? ' <span class="text-danger">*</span></label>' : ''; ?></label></label>
                                            <textarea name="<?php echo e($row->name); ?>" id="<?php echo e($row->name); ?>" cols="10" rows="3"
                                                placeholder="<?php echo e(ucwords(str_replace('_', ' ', $row->name))); ?>" class="form-control edit_textarea"
                                                <?php echo e($row->is_required === 1 ? 'required' : ''); ?>></textarea>
                                        </div>
                                    <?php endif; ?>
                                    <?php if($row->type === 'file'): ?>
                                        <div class="form-group col-sm-12 col-md-4">
                                            ...
                                            <input type="hidden" id="<?php echo e($row->name); ?>-hidden"
                                                name="<?php echo e($row->name); ?>" />
                                            <div id="<?php echo e($row->name); ?>-div" style="display: none" class="edit_file mt-3">
                                                <a href="" id="<?php echo e($row->name); ?>" target="_blank"
                                                    rel="noopener noreferrer"><?php echo e($row->name); ?></a>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input type="checkbox" name="parent" value="Parent" class="form-check-input"
                                                id="show-edit-parents-details"><?php echo e(__('parents_details')); ?>
                            ...
                            <div class="row" id="edit_parents_div" style="display:none;">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <?php echo Form::text('father_first_name', null, [
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    <label><?php echo e(__('father') . ' ' . __('last_name')); ?> <span
                                            class="text-danger">*</span></label>
                                    <?php echo Form::text('father_last_name', null, [
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <?php echo Form::text('father_mobile', null, [
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <?php echo Form::text('father_dob', null, [
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    <label><?php echo e(__('father') . ' ' . __('occupation')); ?> <span
                                            class="text-danger">*</span></label>
                                    <?php echo Form::text('father_occupation', null, [
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    <label><?php echo e(__('mother') . ' ' . __('first_name')); ?> <span
                                            class="text-danger">*</span></label>
                                    <?php echo Form::text('mother_first_name', null, [
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    <label><?php echo e(__('mother') . ' ' . __('last_name')); ?> <span
                                            class="text-danger">*</span></label>
                                    <?php echo Form::text('mother_last_name', null, [
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <?php echo Form::text('mother_mobile', null, [
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <?php echo Form::text('mother_dob', null, [
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    <label><?php echo e(__('mother') . ' ' . __('occupation')); ?> <span
                                            class="text-danger">*</span></label>
                                    <?php echo Form::text('mother_occupation', null, [
                            ...
                            <div class="row" id="edit_guardian_div" style="display:none;">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    <label><?php echo e(__('guardian') . ' ' . __('first_name')); ?> <span
                                            class="text-danger">*</span></label>
                                    <?php echo Form::text('guardian_first_name', null, [
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    <label><?php echo e(__('guardian') . ' ' . __('last_name')); ?> <span
                                            class="text-danger">*</span></label>
                                    <?php echo Form::text('guardian_last_name', null, [
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    <label><?php echo e(__('guardian') . ' ' . __('mobile')); ?> <span
                                            class="text-danger">*</span></label>
                                    <?php echo Form::text('guardian_mobile', null, [
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <?php echo Form::text('guardian_dob', null, [
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    <label><?php echo e(__('guardian') . ' ' . __('occupation')); ?> <span
                                            class="text-danger">*</span></label>
                                    <?php echo Form::text('guardian_occupation', null, [
                            ...
                            <div class="row">
                                <div class="form-group col-sm-6 col-md-12">
                                    ...
                                    <div class="d-flex">
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <?php echo Form::radio('status', '1', false, ['class' => 'student_active', 'id' => 'student_active']); ?>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <?php echo Form::radio('status', '0', false, ['class' => 'student_inactive', 'id' => 'student_inactive']); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/public_html/smartschoolpay/resources/views/students/online_registration.blade.php ENDPATH**/ ?>