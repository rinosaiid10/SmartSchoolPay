            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="pt-3 assign-class-subject-form" id="create-form" action="<?php echo e(route('class.subject.update')); ?>" novalidate="novalidate">

                            <input type="hidden" name="class_id" id="class_id" value="<?php echo e($class->id); ?>" />
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="class_name" type="text" id="edit_class_id" class="form-control"
                                            value="<?php echo e($class->name . ' - ' . $class->medium->name); ?> <?php echo e($class->streams->name ?? ' '); ?>"
                                            readonly />
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label><?php echo e(__('include_semesters')); ?> <span class="text-danger">*</span></label>
                                        <input name="include_semesters" type="text" id="include_semesters"
                                            class="form-control" value="<?php echo e($class->include_semesters == 1 ? 'Yes' : 'No'); ?>"
                                            readonly />
                                    </div>
                                </div>
                                <div class="row">
                                                ...
                                                <div class="col-5 semester-div">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="edit_core_subject[0][semester_id]"
                                                            ...
                                                            disabled="true">
                                                            <option value="" hidden="">--
                                                                <?php echo e(__('Select Semester')); ?> --</option>
                                                            <?php $__currentLoopData = $semesters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $semester): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($semester->id); ?>"><?php echo e($semester->name); ?>
                                                    ...
                                                    <select name="edit_core_subject[0][subject_id]"
                                                        ...
                                                        <?php $__currentLoopData = $subjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($subject->id); ?>"
                                                                data-medium-id="<?php echo e($subject->medium_id); ?>">
                                                            ...
                                                            <select name="edit_elective_subjects[0][semester_id]"
                                                                ...
                                                                <?php $__currentLoopData = $semesters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $semester): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <option value="<?php echo e($semester->id); ?>">
                                                                        <?php echo e($semester->name); ?></option>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-3">
                                                    ...
                                                    <input name="edit_elective_subjects[0][total_selectable_subjects]"
                                                        type="number"
                                                        placeholder="<?php echo e(__('total_selectable_subjects')); ?>"
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        $(document).ready(function() {
            ...
            <?php if($class->coreSubject): ?>

                var coreSubjects = <?php echo json_encode($class->coreSubject, 15, 512) ?>;
                var tempIndex = 0;
            ...
            <?php if($class->electiveSubjectGroup): ?>
                var electiveSubjectGroups = <?php echo json_encode($class->electiveSubjectGroup, 15, 512) ?>;
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/public_html/smartschoolpay/resources/views/class/edit_subject.blade.php ENDPATH**/ ?>