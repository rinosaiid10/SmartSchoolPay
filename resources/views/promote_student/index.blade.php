                        ...
                        <tr>
                            <th scope="col" data-field="id" data-sortable="true" data-visible="false">
                                ...
                                <th scope="col" data-escape="false" data-field="student_id" data-sortable="true">
                                    ...
                                    <th scope="col" data-escape="false" data-field="result" data-sortable="false">{{ __('result') }}
                                    </th>
                                    <th scope="col" data-escape="false" data-field="status" data-sortable="false">{{ __('status') }}
                                    </th>
                                </tr>
                            </thead>
                        </table>
